...
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {valid}]
...
set_input_delay 2.0000 -clock [get_clocks {clk}] -add_delay [get_ports {write}]
...
set_driving_cell -lib_cell sky130_fd_sc_hd__inv_2 -pin {Y} -input_transition_rise 0.0000 -input_transition_fall 0.0000 [get_ports {write}]
