module top (clk,
 ...
 sky130_fd_sc_hd__inv_2 _0692_ (.A(\core_b[7] ),
    .Y(_0081_));
 sky130_fd_sc_hd__inv_2 _0693_ (.A(addr[3]),
    .Y(_0082_));
 sky130_fd_sc_hd__inv_2 _0694_ (.A(rst),
    .Y(_0083_));
 sky130_fd_sc_hd__and3_2 _0695_ (.A(wdata[0]),
    .B(valid),
    .C(write),
    .X(_0084_));
 sky130_fd_sc_hd__or4b_2 _0696_ (.A(addr[1]),
    .B(addr[0]),
    .C(addr[2]),
    .D_N(_0084_),
    .X(_0085_));
 sky130_fd_sc_hd__or4_2 _0697_ (.A(addr[5]),
    .B(addr[4]),
    .C(addr[7]),
    .D(addr[6]),
    .X(_0086_));
 sky130_fd_sc_hd__or2_2 _0698_ (.A(_0082_),
    .B(_0086_),
    .X(_0087_));
 sky130_fd_sc_hd__nor3_2 _0699_ (.A(rst),
    .B(_0085_),
    .C(_0087_),
    .Y(_0000_));
 sky130_fd_sc_hd__or2_2 _0700_ (.A(addr[3]),
    .B(_0086_),
    .X(_0088_));
 sky130_fd_sc_hd__nor4_2 _0701_ (.A(addr[1]),
    .B(addr[0]),
    .C(addr[2]),
    .D(_0088_),
    .Y(_0089_));
 sky130_fd_sc_hd__and3_2 _0702_ (.A(valid),
    .B(write),
    .C(_0089_),
    .X(_0090_));
 sky130_fd_sc_hd__mux2_1 _0703_ (.A0(\core_a[0] ),
    .A1(wdata[0]),
    .S(_0090_),
    .X(_0091_));
 sky130_fd_sc_hd__and2_2 _0704_ (.A(_0083_),
    .B(_0091_),
    .X(_0001_));
 sky130_fd_sc_hd__mux2_1 _0705_ (.A0(\core_a[1] ),
    .A1(wdata[1]),
    .S(_0090_),
    .X(_0092_));
 sky130_fd_sc_hd__and2_2 _0706_ (.A(_0083_),
    .B(_0092_),
    .X(_0002_));
 sky130_fd_sc_hd__mux2_1 _0707_ (.A0(\core_a[2] ),
    .A1(wdata[2]),
    .S(_0090_),
    .X(_0093_));
 sky130_fd_sc_hd__and2_2 _0708_ (.A(_0083_),
    .B(_0093_),
    .X(_0003_));
 sky130_fd_sc_hd__mux2_1 _0709_ (.A0(\core_a[3] ),
    .A1(wdata[3]),
    .S(_0090_),
    .X(_0094_));
 sky130_fd_sc_hd__and2_2 _0710_ (.A(_0083_),
    .B(_0094_),
    .X(_0004_));
 sky130_fd_sc_hd__mux2_1 _0711_ (.A0(\core_a[4] ),
    .A1(wdata[4]),
    .S(_0090_),
    .X(_0095_));
 sky130_fd_sc_hd__and2_2 _0712_ (.A(_0083_),
    .B(_0095_),
    .X(_0005_));
 sky130_fd_sc_hd__mux2_1 _0713_ (.A0(\core_a[5] ),
    .A1(wdata[5]),
    .S(_0090_),
    .X(_0096_));
 sky130_fd_sc_hd__and2_2 _0714_ (.A(_0083_),
    .B(_0096_),
    .X(_0006_));
 sky130_fd_sc_hd__mux2_1 _0715_ (.A0(\core_a[6] ),
    .A1(wdata[6]),
    .S(_0090_),
    .X(_0097_));
 sky130_fd_sc_hd__and2_2 _0716_ (.A(_0083_),
    .B(_0097_),
    .X(_0007_));
 sky130_fd_sc_hd__mux2_1 _0717_ (.A0(\core_a[7] ),
    .A1(wdata[7]),
    .S(_0090_),
    .X(_0098_));
 sky130_fd_sc_hd__and2_2 _0718_ (.A(_0083_),
    .B(_0098_),
    .X(_0008_));
 sky130_fd_sc_hd__or3b_2 _0719_ (.A(addr[1]),
    .B(addr[0]),
    .C_N(addr[2]),
    .X(_0099_));
 sky130_fd_sc_hd__nor2_2 _0720_ (.A(_0088_),
    .B(_0099_),
    .Y(_0100_));
 sky130_fd_sc_hd__and2b_2 _0721_ (.A_N(write),
    .B(valid),
    .X(_0101_));
 sky130_fd_sc_hd__nand2b_2 _0722_ (.A_N(write),
    .B(valid),
    .Y(_0102_));
 sky130_fd_sc_hd__nor2_2 _0723_ (.A(_0087_),
    .B(_0099_),
    .Y(_0103_));
 sky130_fd_sc_hd__a22o_2 _0724_ (.A1(\core_a[0] ),
    .A2(_0089_),
    .B1(_0103_),
    .B2(\core_out[0] ),
    .X(_0104_));
 sky130_fd_sc_hd__a211o_2 _0725_ (.A1(\core_b[0] ),
    .A2(_0100_),
    .B1(_0102_),
    .C1(_0104_),
    .X(_0105_));
 sky130_fd_sc_hd__o211a_2 _0726_ (.A1(rdata[0]),
    .A2(_0101_),
    .B1(_0105_),
    .C1(_0083_),
    .X(_0009_));
 sky130_fd_sc_hd__a22o_2 _0727_ (.A1(\core_a[1] ),
    .A2(_0089_),
    .B1(_0100_),
    .B2(\core_b[1] ),
    .X(_0106_));
 sky130_fd_sc_hd__a211o_2 _0728_ (.A1(\core_out[1] ),
    .A2(_0103_),
    .B1(_0106_),
    .C1(_0102_),
    .X(_0107_));
 sky130_fd_sc_hd__o211a_2 _0729_ (.A1(rdata[1]),
    .A2(_0101_),
    .B1(_0107_),
    .C1(_0083_),
    .X(_0010_));
 sky130_fd_sc_hd__a22o_2 _0730_ (.A1(\core_a[2] ),
    .A2(_0089_),
    .B1(_0100_),
    .B2(\core_b[2] ),
    .X(_0108_));
 sky130_fd_sc_hd__a211o_2 _0731_ (.A1(\core_out[2] ),
    .A2(_0103_),
    .B1(_0108_),
    .C1(_0102_),
    .X(_0109_));
 sky130_fd_sc_hd__o211a_2 _0732_ (.A1(rdata[2]),
    .A2(_0101_),
    .B1(_0109_),
    .C1(_0083_),
    .X(_0011_));
 sky130_fd_sc_hd__a22o_2 _0733_ (.A1(\core_b[3] ),
    .A2(_0100_),
    .B1(_0103_),
    .B2(\core_out[3] ),
    .X(_0110_));
 sky130_fd_sc_hd__a211o_2 _0734_ (.A1(\core_a[3] ),
    .A2(_0089_),
    .B1(_0102_),
    .C1(_0110_),
    .X(_0111_));
 sky130_fd_sc_hd__o211a_2 _0735_ (.A1(rdata[3]),
    .A2(_0101_),
    .B1(_0111_),
    .C1(_0083_),
    .X(_0012_));
 sky130_fd_sc_hd__a22o_2 _0736_ (.A1(\core_a[4] ),
    .A2(_0089_),
    .B1(_0100_),
    .B2(\core_b[4] ),
    .X(_0112_));
 sky130_fd_sc_hd__a211o_2 _0737_ (.A1(\core_out[4] ),
    .A2(_0103_),
    .B1(_0112_),
    .C1(_0102_),
    .X(_0113_));
 sky130_fd_sc_hd__o211a_2 _0738_ (.A1(rdata[4]),
    .A2(_0101_),
    .B1(_0113_),
    .C1(_0083_),
    .X(_0013_));
 sky130_fd_sc_hd__a22o_2 _0739_ (.A1(\core_a[5] ),
    .A2(_0089_),
    .B1(_0100_),
    .B2(\core_b[5] ),
    .X(_0114_));
 sky130_fd_sc_hd__a211o_2 _0740_ (.A1(\core_out[5] ),
    .A2(_0103_),
    .B1(_0114_),
    .C1(_0102_),
    .X(_0115_));
 sky130_fd_sc_hd__o211a_2 _0741_ (.A1(rdata[5]),
    .A2(_0101_),
    .B1(_0115_),
    .C1(_0083_),
    .X(_0014_));
 sky130_fd_sc_hd__a22o_2 _0742_ (.A1(\core_a[6] ),
    .A2(_0089_),
    .B1(_0100_),
    .B2(\core_b[6] ),
    .X(_0116_));
 sky130_fd_sc_hd__a211o_2 _0743_ (.A1(\core_out[6] ),
    .A2(_0103_),
    .B1(_0116_),
    .C1(_0102_),
    .X(_0117_));
 sky130_fd_sc_hd__o211a_2 _0744_ (.A1(rdata[6]),
    .A2(_0101_),
    .B1(_0117_),
    .C1(_0083_),
    .X(_0015_));
 sky130_fd_sc_hd__and2_2 _0745_ (.A(\core_out[7] ),
    .B(_0103_),
    .X(_0118_));
 sky130_fd_sc_hd__a221o_2 _0746_ (.A1(\core_a[7] ),
    .A2(_0089_),
    .B1(_0100_),
    .B2(\core_b[7] ),
    .C1(_0102_),
    .X(_0119_));
 sky130_fd_sc_hd__o221a_2 _0747_ (.A1(rdata[7]),
    .A2(_0101_),
    .B1(_0118_),
    .B2(_0119_),
    .C1(_0083_),
    .X(_0016_));
 sky130_fd_sc_hd__and2_2 _0748_ (.A(\core_out[8] ),
    .B(_0103_),
    .X(_0120_));
 sky130_fd_sc_hd__o221a_2 _0749_ (.A1(rdata[8]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0120_),
    .C1(_0083_),
    .X(_0017_));
 sky130_fd_sc_hd__and2_2 _0750_ (.A(\core_out[9] ),
    .B(_0103_),
    .X(_0121_));
 sky130_fd_sc_hd__o221a_2 _0751_ (.A1(rdata[9]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0121_),
    .C1(_0083_),
    .X(_0018_));
 sky130_fd_sc_hd__and2_2 _0752_ (.A(\core_out[10] ),
    .B(_0103_),
    .X(_0122_));
 sky130_fd_sc_hd__o221a_2 _0753_ (.A1(rdata[10]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0122_),
    .C1(_0083_),
    .X(_0019_));
 sky130_fd_sc_hd__and2_2 _0754_ (.A(\core_out[11] ),
    .B(_0103_),
    .X(_0123_));
 sky130_fd_sc_hd__o221a_2 _0755_ (.A1(rdata[11]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0123_),
    .C1(_0083_),
    .X(_0020_));
 sky130_fd_sc_hd__and2_2 _0756_ (.A(\core_out[12] ),
    .B(_0103_),
    .X(_0124_));
 sky130_fd_sc_hd__o221a_2 _0757_ (.A1(rdata[12]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0124_),
    .C1(_0083_),
    .X(_0021_));
 sky130_fd_sc_hd__and2_2 _0758_ (.A(\core_out[13] ),
    .B(_0103_),
    .X(_0125_));
 sky130_fd_sc_hd__o221a_2 _0759_ (.A1(rdata[13]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0125_),
    .C1(_0083_),
    .X(_0022_));
 sky130_fd_sc_hd__and2_2 _0760_ (.A(\core_out[14] ),
    .B(_0103_),
    .X(_0126_));
 sky130_fd_sc_hd__o221a_2 _0761_ (.A1(rdata[14]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0126_),
    .C1(_0083_),
    .X(_0023_));
 sky130_fd_sc_hd__and2_2 _0762_ (.A(\core_out[15] ),
    .B(_0103_),
    .X(_0127_));
 sky130_fd_sc_hd__o221a_2 _0763_ (.A1(rdata[15]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0127_),
    .C1(_0083_),
    .X(_0024_));
 sky130_fd_sc_hd__and2_2 _0764_ (.A(\core_out[16] ),
    .B(_0103_),
    .X(_0128_));
 sky130_fd_sc_hd__o221a_2 _0765_ (.A1(rdata[16]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0128_),
    .C1(_0083_),
    .X(_0025_));
 sky130_fd_sc_hd__and2_2 _0766_ (.A(\core_out[17] ),
    .B(_0103_),
    .X(_0129_));
 sky130_fd_sc_hd__o221a_2 _0767_ (.A1(rdata[17]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0129_),
    .C1(_0083_),
    .X(_0026_));
 sky130_fd_sc_hd__and2_2 _0768_ (.A(\core_out[18] ),
    .B(_0103_),
    .X(_0130_));
 sky130_fd_sc_hd__o221a_2 _0769_ (.A1(rdata[18]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0130_),
    .C1(_0083_),
    .X(_0027_));
 sky130_fd_sc_hd__and2_2 _0770_ (.A(\core_out[19] ),
    .B(_0103_),
    .X(_0131_));
 sky130_fd_sc_hd__o221a_2 _0771_ (.A1(rdata[19]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0131_),
    .C1(_0083_),
    .X(_0028_));
 sky130_fd_sc_hd__and2_2 _0772_ (.A(\core_out[20] ),
    .B(_0103_),
    .X(_0132_));
 sky130_fd_sc_hd__o221a_2 _0773_ (.A1(rdata[20]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0132_),
    .C1(_0083_),
    .X(_0029_));
 sky130_fd_sc_hd__and2_2 _0774_ (.A(\core_out[21] ),
    .B(_0103_),
    .X(_0133_));
 sky130_fd_sc_hd__o221a_2 _0775_ (.A1(rdata[21]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0133_),
    .C1(_0083_),
    .X(_0030_));
 sky130_fd_sc_hd__and2_2 _0776_ (.A(\core_out[22] ),
    .B(_0103_),
    .X(_0134_));
 sky130_fd_sc_hd__o221a_2 _0777_ (.A1(rdata[22]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0134_),
    .C1(_0083_),
    .X(_0031_));
 sky130_fd_sc_hd__and2_2 _0778_ (.A(\core_out[23] ),
    .B(_0103_),
    .X(_0135_));
 sky130_fd_sc_hd__o221a_2 _0779_ (.A1(rdata[23]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0135_),
    .C1(_0083_),
    .X(_0032_));
 sky130_fd_sc_hd__and2_2 _0780_ (.A(\core_out[24] ),
    .B(_0103_),
    .X(_0136_));
 sky130_fd_sc_hd__o221a_2 _0781_ (.A1(rdata[24]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0136_),
    .C1(_0083_),
    .X(_0033_));
 sky130_fd_sc_hd__and2_2 _0782_ (.A(\core_out[25] ),
    .B(_0103_),
    .X(_0137_));
 sky130_fd_sc_hd__o221a_2 _0783_ (.A1(rdata[25]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0137_),
    .C1(_0083_),
    .X(_0034_));
 sky130_fd_sc_hd__and2_2 _0784_ (.A(\core_out[26] ),
    .B(_0103_),
    .X(_0138_));
 sky130_fd_sc_hd__o221a_2 _0785_ (.A1(rdata[26]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0138_),
    .C1(_0083_),
    .X(_0035_));
 sky130_fd_sc_hd__and2_2 _0786_ (.A(\core_out[27] ),
    .B(_0103_),
    .X(_0139_));
 sky130_fd_sc_hd__o221a_2 _0787_ (.A1(rdata[27]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0139_),
    .C1(_0083_),
    .X(_0036_));
 sky130_fd_sc_hd__and2_2 _0788_ (.A(\core_out[28] ),
    .B(_0103_),
    .X(_0140_));
 sky130_fd_sc_hd__o221a_2 _0789_ (.A1(rdata[28]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0140_),
    .C1(_0083_),
    .X(_0037_));
 sky130_fd_sc_hd__and2_2 _0790_ (.A(\core_out[29] ),
    .B(_0103_),
    .X(_0141_));
 sky130_fd_sc_hd__o221a_2 _0791_ (.A1(rdata[29]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0141_),
    .C1(_0083_),
    .X(_0038_));
 sky130_fd_sc_hd__and2_2 _0792_ (.A(\core_out[30] ),
    .B(_0103_),
    .X(_0142_));
 sky130_fd_sc_hd__o221a_2 _0793_ (.A1(rdata[30]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0142_),
    .C1(_0083_),
    .X(_0039_));
 sky130_fd_sc_hd__and2_2 _0794_ (.A(\core_out[31] ),
    .B(_0103_),
    .X(_0143_));
 sky130_fd_sc_hd__o221a_2 _0795_ (.A1(rdata[31]),
    .A2(_0101_),
    .B1(_0119_),
    .B2(_0143_),
    .C1(_0083_),
    .X(_0040_));
 sky130_fd_sc_hd__and3_2 _0796_ (.A(valid),
    .B(write),
    .C(_0100_),
    .X(_0144_));
 sky130_fd_sc_hd__mux2_1 _0797_ (.A0(\core_b[0] ),
    .A1(wdata[0]),
    .S(_0144_),
    .X(_0145_));
 sky130_fd_sc_hd__and2_2 _0798_ (.A(_0083_),
    .B(_0145_),
    .X(_0041_));
 sky130_fd_sc_hd__mux2_1 _0799_ (.A0(\core_b[1] ),
    .A1(wdata[1]),
    .S(_0144_),
    .X(_0146_));
 sky130_fd_sc_hd__and2_2 _0800_ (.A(_0083_),
    .B(_0146_),
    .X(_0042_));
 sky130_fd_sc_hd__mux2_1 _0801_ (.A0(\core_b[2] ),
    .A1(wdata[2]),
    .S(_0144_),
    .X(_0147_));
 sky130_fd_sc_hd__and2_2 _0802_ (.A(_0083_),
    .B(_0147_),
    .X(_0043_));
 sky130_fd_sc_hd__mux2_1 _0803_ (.A0(\core_b[3] ),
    .A1(wdata[3]),
    .S(_0144_),
    .X(_0148_));
 sky130_fd_sc_hd__and2_2 _0804_ (.A(_0083_),
    .B(_0148_),
    .X(_0044_));
 sky130_fd_sc_hd__mux2_1 _0805_ (.A0(\core_b[4] ),
    .A1(wdata[4]),
    .S(_0144_),
    .X(_0149_));
 sky130_fd_sc_hd__and2_2 _0806_ (.A(_0083_),
    .B(_0149_),
    .X(_0045_));
 sky130_fd_sc_hd__mux2_1 _0807_ (.A0(\core_b[5] ),
    .A1(wdata[5]),
    .S(_0144_),
    .X(_0150_));
 sky130_fd_sc_hd__and2_2 _0808_ (.A(_0083_),
    .B(_0150_),
    .X(_0046_));
 sky130_fd_sc_hd__mux2_1 _0809_ (.A0(\core_b[6] ),
    .A1(wdata[6]),
    .S(_0144_),
    .X(_0151_));
 sky130_fd_sc_hd__and2_2 _0810_ (.A(_0083_),
    .B(_0151_),
    .X(_0047_));
 sky130_fd_sc_hd__mux2_1 _0811_ (.A0(\core_b[7] ),
    .A1(wdata[7]),
    .S(_0144_),
    .X(_0152_));
 sky130_fd_sc_hd__and2_2 _0812_ (.A(_0083_),
    .B(_0152_),
    .X(_0048_));
 sky130_fd_sc_hd__a31o_2 _0813_ (.A1(core_valid),
    .A2(\core_b[0] ),
    .A3(\core_a[0] ),
    .B1(\core_out[0] ),
    .X(_0153_));
 sky130_fd_sc_hd__and3_2 _0814_ (.A(\core_out[0] ),
    .B(\core_b[0] ),
    .C(\core_a[0] ),
    .X(_0154_));
 sky130_fd_sc_hd__nand2_2 _0815_ (.A(core_valid),
    .B(_0154_),
    .Y(_0155_));
 sky130_fd_sc_hd__and3_2 _0816_ (.A(_0083_),
    .B(_0153_),
    .C(_0155_),
    .X(_0049_));
 sky130_fd_sc_hd__a22o_2 _0817_ (.A1(\core_b[0] ),
    .A2(\core_a[1] ),
    .B1(\core_a[0] ),
    .B2(\core_b[1] ),
    .X(_0156_));
 sky130_fd_sc_hd__and4_2 _0818_ (.A(\core_b[1] ),
    .B(\core_b[0] ),
    .C(\core_a[1] ),
    .D(\core_a[0] ),
    .X(_0157_));
 sky130_fd_sc_hd__nand4_2 _0819_ (.A(\core_b[1] ),
    .B(\core_b[0] ),
    .C(\core_a[1] ),
    .D(\core_a[0] ),
    .Y(_0158_));
 sky130_fd_sc_hd__and3_2 _0820_ (.A(\core_out[1] ),
    .B(_0156_),
    .C(_0158_),
    .X(_0159_));
 sky130_fd_sc_hd__a21oi_2 _0821_ (.A1(_0156_),
    .A2(_0158_),
    .B1(\core_out[1] ),
    .Y(_0160_));
 sky130_fd_sc_hd__nor2_2 _0822_ (.A(_0159_),
    .B(_0160_),
    .Y(_0161_));
 sky130_fd_sc_hd__xnor2_2 _0823_ (.A(_0154_),
    .B(_0161_),
    .Y(_0162_));
 sky130_fd_sc_hd__nand2_2 _0824_ (.A(core_valid),
    .B(_0162_),
    .Y(_0163_));
 sky130_fd_sc_hd__o211a_2 _0825_ (.A1(core_valid),
    .A2(\core_out[1] ),
    .B1(_0083_),
    .C1(_0163_),
    .X(_0050_));
 sky130_fd_sc_hd__nand2_2 _0826_ (.A(\core_b[2] ),
    .B(\core_a[0] ),
    .Y(_0164_));
 sky130_fd_sc_hd__and4_2 _0827_ (.A(\core_b[1] ),
    .B(\core_b[0] ),
    .C(\core_a[2] ),
    .D(\core_a[1] ),
    .X(_0165_));
 sky130_fd_sc_hd__a22oi_2 _0828_ (.A1(\core_b[0] ),
    .A2(\core_a[2] ),
    .B1(\core_a[1] ),
    .B2(\core_b[1] ),
    .Y(_0166_));
 sky130_fd_sc_hd__or3_2 _0829_ (.A(_0164_),
    .B(_0165_),
    .C(_0166_),
    .X(_0167_));
 sky130_fd_sc_hd__o21ai_2 _0830_ (.A1(_0165_),
    .A2(_0166_),
    .B1(_0164_),
    .Y(_0168_));
 sky130_fd_sc_hd__and3_2 _0831_ (.A(_0157_),
    .B(_0167_),
    .C(_0168_),
    .X(_0169_));
 sky130_fd_sc_hd__a21oi_2 _0832_ (.A1(_0167_),
    .A2(_0168_),
    .B1(_0157_),
    .Y(_0170_));
 sky130_fd_sc_hd__nor2_2 _0833_ (.A(_0169_),
    .B(_0170_),
    .Y(_0171_));
 sky130_fd_sc_hd__nand2_2 _0834_ (.A(\core_out[2] ),
    .B(_0171_),
    .Y(_0172_));
 sky130_fd_sc_hd__or2_2 _0835_ (.A(\core_out[2] ),
    .B(_0171_),
    .X(_0173_));
 sky130_fd_sc_hd__nand2_2 _0836_ (.A(_0172_),
    .B(_0173_),
    .Y(_0174_));
 sky130_fd_sc_hd__a21oi_2 _0837_ (.A1(_0154_),
    .A2(_0161_),
    .B1(_0159_),
    .Y(_0175_));
 sky130_fd_sc_hd__xnor2_2 _0838_ (.A(_0174_),
    .B(_0175_),
    .Y(_0176_));
 sky130_fd_sc_hd__nand2_2 _0839_ (.A(core_valid),
    .B(_0176_),
    .Y(_0177_));
 sky130_fd_sc_hd__o211a_2 _0840_ (.A1(core_valid),
    .A2(\core_out[2] ),
    .B1(_0083_),
    .C1(_0177_),
    .X(_0051_));
 sky130_fd_sc_hd__nand2_2 _0841_ (.A(\core_b[2] ),
    .B(\core_a[1] ),
    .Y(_0178_));
 sky130_fd_sc_hd__and4_2 _0842_ (.A(\core_b[1] ),
    .B(\core_b[0] ),
    .C(\core_a[3] ),
    .D(\core_a[2] ),
    .X(_0179_));
 sky130_fd_sc_hd__a22oi_2 _0843_ (.A1(\core_b[0] ),
    ...
    .B2(\core_b[1] ),
    .Y(_0180_));
 sky130_fd_sc_hd__or3_2 _0844_ (.A(_0178_),
    .B(_0179_),
    .C(_0180_),
    .X(_0181_));
 sky130_fd_sc_hd__o21ai_2 _0845_ (.A1(_0179_),
    .A2(_0180_),
    .B1(_0178_),
    .Y(_0182_));
 sky130_fd_sc_hd__o21bai_2 _0846_ (.A1(_0164_),
    .A2(_0166_),
    .B1_N(_0165_),
    .Y(_0183_));
 sky130_fd_sc_hd__nand3_2 _0847_ (.A(_0181_),
    .B(_0182_),
    .C(_0183_),
    .Y(_0184_));
 sky130_fd_sc_hd__a21o_2 _0848_ (.A1(_0181_),
    .A2(_0182_),
    .B1(_0183_),
    .X(_0185_));
 sky130_fd_sc_hd__nand4_2 _0849_ (.A(\core_b[3] ),
    .B(\core_a[0] ),
    .C(_0184_),
    .D(_0185_),
    .Y(_0186_));
 sky130_fd_sc_hd__a22o_2 _0850_ (.A1(\core_b[3] ),
    .A2(\core_a[0] ),
    .B1(_0184_),
    .B2(_0185_),
    .X(_0187_));
 sky130_fd_sc_hd__and3_2 _0851_ (.A(_0169_),
    .B(_0186_),
    .C(_0187_),
    .X(_0188_));
 sky130_fd_sc_hd__a21oi_2 _0852_ (.A1(_0186_),
    .A2(_0187_),
    .B1(_0169_),
    .Y(_0189_));
 sky130_fd_sc_hd__nor2_2 _0853_ (.A(_0188_),
    .B(_0189_),
    .Y(_0190_));
 sky130_fd_sc_hd__nand2_2 _0854_ (.A(\core_out[3] ),
    .B(_0190_),
    .Y(_0191_));
 sky130_fd_sc_hd__or2_2 _0855_ (.A(\core_out[3] ),
    .B(_0190_),
    .X(_0192_));
 sky130_fd_sc_hd__nand2_2 _0856_ (.A(_0191_),
    .B(_0192_),
    .Y(_0193_));
 sky130_fd_sc_hd__o21ai_2 _0857_ (.A1(_0174_),
    .A2(_0175_),
    .B1(_0172_),
    .Y(_0194_));
 sky130_fd_sc_hd__xor2_2 _0858_ (.A(_0193_),
    .B(_0194_),
    .X(_0195_));
 sky130_fd_sc_hd__nand2_2 _0859_ (.A(core_valid),
    .B(_0195_),
    .Y(_0196_));
 sky130_fd_sc_hd__o211a_2 _0860_ (.A1(core_valid),
    .A2(\core_out[3] ),
    .B1(_0083_),
    .C1(_0196_),
    .X(_0052_));
 sky130_fd_sc_hd__a22oi_2 _0861_ (.A1(\core_b[3] ),
    .A2(\core_a[1] ),
    .B1(\core_a[0] ),
    .B2(\core_b[4] ),
    .Y(_0197_));
 sky130_fd_sc_hd__and4_2 _0862_ (.A(\core_b[4] ),
    .B(\core_b[3] ),
    .C(\core_a[1] ),
    .D(\core_a[0] ),
    .X(_0198_));
 sky130_fd_sc_hd__nor2_2 _0863_ (.A(_0197_),
    .B(_0198_),
    .Y(_0199_));
 sky130_fd_sc_hd__nand2_2 _0864_ (.A(\core_b[2] ),
    .B(\core_a[2] ),
    .Y(_0200_));
 sky130_fd_sc_hd__and4_2 _0865_ (.A(\core_b[1] ),
    .B(\core_b[0] ),
    .C(\core_a[4] ),
    .D(\core_a[3] ),
    .X(_0201_));
 sky130_fd_sc_hd__a22oi_2 _0866_ (.A1(\core_b[0] ),
    .A2(\core_a[4] ),
    .B1(\core_a[3] ),
    .B2(\core_b[1] ),
    .Y(_0202_));
 sky130_fd_sc_hd__or3_2 _0867_ (.A(_0200_),
    .B(_0201_),
    .C(_0202_),
    .X(_0203_));
 sky130_fd_sc_hd__o21ai_2 _0868_ (.A1(_0201_),
    .A2(_0202_),
    .B1(_0200_),
    .Y(_0204_));
 sky130_fd_sc_hd__o21bai_2 _0869_ (.A1(_0178_),
    .A2(_0180_),
    .B1_N(_0179_),
    .Y(_0205_));
 sky130_fd_sc_hd__nand3_2 _0870_ (.A(_0203_),
    .B(_0204_),
    .C(_0205_),
    .Y(_0206_));
 sky130_fd_sc_hd__a21o_2 _0871_ (.A1(_0203_),
    .A2(_0204_),
    .B1(_0205_),
    .X(_0207_));
 sky130_fd_sc_hd__nand3_2 _0872_ (.A(_0199_),
    .B(_0206_),
    .C(_0207_),
    .Y(_0208_));
 sky130_fd_sc_hd__a21o_2 _0873_ (.A1(_0206_),
    .A2(_0207_),
    .B1(_0199_),
    .X(_0209_));
 sky130_fd_sc_hd__nand2_2 _0874_ (.A(_0184_),
    .B(_0186_),
    .Y(_0210_));
 sky130_fd_sc_hd__and3_2 _0875_ (.A(_0208_),
    .B(_0209_),
    .C(_0210_),
    .X(_0211_));
 sky130_fd_sc_hd__a21oi_2 _0876_ (.A1(_0208_),
    .A2(_0209_),
    .B1(_0210_),
    .Y(_0212_));
 sky130_fd_sc_hd__or3b_2 _0877_ (.A(_0211_),
    ...
    .C_N(_0188_),
    .X(_0213_));
 sky130_fd_sc_hd__o21bai_2 _0878_ (.A1(_0211_),
    .A2(_0212_),
    .B1_N(_0188_),
    .Y(_0214_));
 sky130_fd_sc_hd__and3_2 _0879_ (.A(\core_out[4] ),
    .B(_0213_),
    .C(_0214_),
    .X(_0215_));
 sky130_fd_sc_hd__a21o_2 _0880_ (.A1(_0213_),
    .A2(_0214_),
    .B1(\core_out[4] ),
    .X(_0216_));
 sky130_fd_sc_hd__nand2b_2 _0881_ (.A_N(_0215_),
    .B(_0216_),
    .Y(_0217_));
 sky130_fd_sc_hd__a21bo_2 _0882_ (.A1(_0192_),
    .A2(_0194_),
    .B1_N(_0191_),
    .X(_0218_));
 sky130_fd_sc_hd__xnor2_2 _0883_ (.A(_0217_),
    .B(_0218_),
    .Y(_0219_));
 sky130_fd_sc_hd__mux2_1 _0884_ (.A0(\core_out[4] ),
    ...
    .S(core_valid),
    .X(_0220_));
 sky130_fd_sc_hd__and2_2 _0885_ (.A(_0083_),
    .B(_0220_),
    .X(_0053_));
 sky130_fd_sc_hd__and4_2 _0886_ (.A(\core_b[4] ),
    .B(\core_b[3] ),
    .C(\core_a[2] ),
    .D(\core_a[1] ),
    .X(_0221_));
 sky130_fd_sc_hd__a22oi_2 _0887_ (.A1(\core_b[3] ),
    .A2(\core_a[2] ),
    .B1(\core_a[1] ),
    .B2(\core_b[4] ),
    .Y(_0222_));
 sky130_fd_sc_hd__or2_2 _0888_ (.A(_0221_),
    .B(_0222_),
    .X(_0223_));
 sky130_fd_sc_hd__nand2_2 _0889_ (.A(\core_b[5] ),
    .B(\core_a[0] ),
    .Y(_0224_));
 sky130_fd_sc_hd__nor2_2 _0890_ (.A(_0223_),
    .B(_0224_),
    .Y(_0225_));
 sky130_fd_sc_hd__xor2_2 _0891_ (.A(_0223_),
    .B(_0224_),
    .X(_0226_));
 sky130_fd_sc_hd__nand2_2 _0892_ (.A(\core_b[2] ),
    .B(\core_a[3] ),
    .Y(_0227_));
 sky130_fd_sc_hd__and4_2 _0893_ (.A(\core_b[1] ),
    .B(\core_b[0] ),
    .C(\core_a[5] ),
    .D(\core_a[4] ),
    .X(_0228_));
 sky130_fd_sc_hd__a22oi_2 _0894_ (.A1(\core_b[0] ),
    .A2(\core_a[5] ),
    .B1(\core_a[4] ),
    .B2(\core_b[1] ),
    .Y(_0229_));
 sky130_fd_sc_hd__or3_2 _0895_ (.A(_0227_),
    .B(_0228_),
    .C(_0229_),
    .X(_0230_));
 sky130_fd_sc_hd__o21ai_2 _0896_ (.A1(_0228_),
    .A2(_0229_),
    .B1(_0227_),
    .Y(_0231_));
 sky130_fd_sc_hd__o21bai_2 _0897_ (.A1(_0200_),
    .A2(_0202_),
    .B1_N(_0201_),
    .Y(_0232_));
 sky130_fd_sc_hd__nand3_2 _0898_ (.A(_0230_),
    .B(_0231_),
    .C(_0232_),
    .Y(_0233_));
 sky130_fd_sc_hd__a21o_2 _0899_ (.A1(_0230_),
    .A2(_0231_),
    .B1(_0232_),
    .X(_0234_));
 sky130_fd_sc_hd__nand3_2 _0900_ (.A(_0226_),
    .B(_0233_),
    .C(_0234_),
    .Y(_0235_));
 sky130_fd_sc_hd__a21o_2 _0901_ (.A1(_0233_),
    .A2(_0234_),
    .B1(_0226_),
    .X(_0236_));
 sky130_fd_sc_hd__a21bo_2 _0902_ (.A1(_0199_),
    .A2(_0207_),
    .B1_N(_0206_),
    .X(_0237_));
 sky130_fd_sc_hd__nand3_2 _0903_ (.A(_0235_),
    ...
    .C(_0237_),
    .Y(_0238_));
 sky130_fd_sc_hd__a21o_2 _0904_ (.A1(_0235_),
    .A2(_0236_),
    .B1(_0237_),
    .X(_0239_));
 sky130_fd_sc_hd__nand3_2 _0905_ (.A(_0198_),
    ...
    .C(_0239_),
    .Y(_0240_));
 sky130_fd_sc_hd__a21o_2 _0906_ (.A1(_0238_),
    .A2(_0239_),
    .B1(_0198_),
    .X(_0241_));
 sky130_fd_sc_hd__nand2_2 _0907_ (.A(_0240_),
    .B(_0241_),
    .Y(_0242_));
 sky130_fd_sc_hd__nand3_2 _0908_ (.A(_0211_),
    .B(_0240_),
    .C(_0241_),
    .Y(_0243_));
 sky130_fd_sc_hd__nand3b_2 _0909_ (.A_N(_0211_),
    .B(_0213_),
    .C(_0242_),
    .Y(_0244_));
 sky130_fd_sc_hd__nor2_2 _0910_ (.A(_0213_),
    .B(_0242_),
    .Y(_0245_));
 sky130_fd_sc_hd__or2_2 _0911_ (.A(_0213_),
    .B(_0242_),
    .X(_0246_));
 sky130_fd_sc_hd__and4_2 _0912_ (.A(\core_out[5] ),
    .B(_0243_),
    .C(_0244_),
    .D(_0246_),
    .X(_0247_));
 sky130_fd_sc_hd__a31o_2 _0913_ (.A1(_0243_),
    .A2(_0244_),
    .A3(_0246_),
    .B1(\core_out[5] ),
    .X(_0248_));
 sky130_fd_sc_hd__nand2b_2 _0914_ (.A_N(_0247_),
    .B(_0248_),
    .Y(_0249_));
 sky130_fd_sc_hd__a21o_2 _0915_ (.A1(_0216_),
    .A2(_0218_),
    .B1(_0215_),
    .X(_0250_));
 sky130_fd_sc_hd__xor2_2 _0916_ (.A(_0249_),
    .B(_0250_),
    .X(_0251_));
 sky130_fd_sc_hd__nand2_2 _0917_ (.A(core_valid),
    .B(_0251_),
    .Y(_0252_));
 sky130_fd_sc_hd__o211a_2 _0918_ (.A1(core_valid),
    .A2(\core_out[5] ),
    .B1(_0083_),
    .C1(_0252_),
    .X(_0054_));
 sky130_fd_sc_hd__o211a_2 _0919_ (.A1(_0221_),
    .A2(_0225_),
    .B1(\core_b[6] ),
    .C1(\core_a[0] ),
    .X(_0253_));
 sky130_fd_sc_hd__a211oi_2 _0920_ (.A1(\core_b[6] ),
    .A2(\core_a[0] ),
    .B1(_0221_),
    .C1(_0225_),
    .Y(_0254_));
 sky130_fd_sc_hd__nor2_2 _0921_ (.A(_0253_),
    .B(_0254_),
    .Y(_0255_));
 sky130_fd_sc_hd__nand2_2 _0922_ (.A(\core_b[5] ),
    .B(\core_a[1] ),
    .Y(_0256_));
 sky130_fd_sc_hd__nand2_2 _0923_ (.A(\core_b[4] ),
    .B(\core_a[3] ),
    .Y(_0257_));
 sky130_fd_sc_hd__and4_2 _0924_ (.A(\core_b[4] ),
    .B(\core_b[3] ),
    .C(\core_a[3] ),
    .D(\core_a[2] ),
    .X(_0258_));
 sky130_fd_sc_hd__a22o_2 _0925_ (.A1(\core_b[3] ),
    .A2(\core_a[3] ),
    .B1(\core_a[2] ),
    .B2(\core_b[4] ),
    .X(_0259_));
 sky130_fd_sc_hd__and2b_2 _0926_ (.A_N(_0258_),
    .B(_0259_),
    .X(_0260_));
 sky130_fd_sc_hd__xnor2_2 _0927_ (.A(_0256_),
    .B(_0260_),
    .Y(_0261_));
 sky130_fd_sc_hd__nand2_2 _0928_ (.A(\core_b[2] ),
    .B(\core_a[4] ),
    .Y(_0262_));
 sky130_fd_sc_hd__nand2_2 _0929_ (.A(\core_b[1] ),
    .B(\core_a[6] ),
    .Y(_0263_));
 sky130_fd_sc_hd__and4_2 _0930_ (.A(\core_b[1] ),
    .B(\core_b[0] ),
    .C(\core_a[6] ),
    .D(\core_a[5] ),
    .X(_0264_));
 sky130_fd_sc_hd__a22oi_2 _0931_ (.A1(\core_b[0] ),
    ...
    .B2(\core_b[1] ),
    .Y(_0265_));
 sky130_fd_sc_hd__nor3_2 _0932_ (.A(_0262_),
    .B(_0264_),
    .C(_0265_),
    .Y(_0266_));
 sky130_fd_sc_hd__or3_2 _0933_ (.A(_0262_),
    .B(_0264_),
    .C(_0265_),
    .X(_0267_));
 sky130_fd_sc_hd__o21ai_2 _0934_ (.A1(_0264_),
    .A2(_0265_),
    .B1(_0262_),
    .Y(_0268_));
 sky130_fd_sc_hd__o21bai_2 _0935_ (.A1(_0227_),
    .A2(_0229_),
    .B1_N(_0228_),
    .Y(_0269_));
 sky130_fd_sc_hd__nand3_2 _0936_ (.A(_0267_),
    .B(_0268_),
    .C(_0269_),
    .Y(_0270_));
 sky130_fd_sc_hd__a21o_2 _0937_ (.A1(_0267_),
    .A2(_0268_),
    .B1(_0269_),
    .X(_0271_));
 sky130_fd_sc_hd__nand3_2 _0938_ (.A(_0261_),
    .B(_0270_),
    .C(_0271_),
    .Y(_0272_));
 sky130_fd_sc_hd__a21o_2 _0939_ (.A1(_0270_),
    .A2(_0271_),
    .B1(_0261_),
    .X(_0273_));
 sky130_fd_sc_hd__a21bo_2 _0940_ (.A1(_0226_),
    .A2(_0234_),
    .B1_N(_0233_),
    .X(_0274_));
 sky130_fd_sc_hd__nand3_2 _0941_ (.A(_0272_),
    ...
    .C(_0274_),
    .Y(_0275_));
 sky130_fd_sc_hd__a21o_2 _0942_ (.A1(_0272_),
    .A2(_0273_),
    .B1(_0274_),
    .X(_0276_));
 sky130_fd_sc_hd__and3_2 _0943_ (.A(_0255_),
    .B(_0275_),
    .C(_0276_),
    .X(_0277_));
 sky130_fd_sc_hd__nand3_2 _0944_ (.A(_0255_),
    .B(_0275_),
    .C(_0276_),
    .Y(_0278_));
 sky130_fd_sc_hd__a21oi_2 _0945_ (.A1(_0275_),
    .A2(_0276_),
    .B1(_0255_),
    .Y(_0279_));
 sky130_fd_sc_hd__a211oi_2 _0946_ (.A1(_0238_),
    ...
    .C1(_0279_),
    .Y(_0280_));
 sky130_fd_sc_hd__o211a_2 _0947_ (.A1(_0277_),
    .A2(_0279_),
    .B1(_0238_),
    .C1(_0240_),
    .X(_0281_));
 sky130_fd_sc_hd__or3_2 _0948_ (.A(_0243_),
    .B(_0280_),
    .C(_0281_),
    .X(_0282_));
 sky130_fd_sc_hd__o21ai_2 _0949_ (.A1(_0280_),
    .A2(_0281_),
    .B1(_0243_),
    .Y(_0283_));
 sky130_fd_sc_hd__a21o_2 _0950_ (.A1(_0282_),
    .A2(_0283_),
    .B1(_0245_),
    .X(_0284_));
 sky130_fd_sc_hd__nand3_2 _0951_ (.A(_0245_),
    .B(_0282_),
    .C(_0283_),
    .Y(_0285_));
 sky130_fd_sc_hd__and3_2 _0952_ (.A(\core_out[6] ),
    .B(_0284_),
    .C(_0285_),
    .X(_0286_));
 sky130_fd_sc_hd__a21o_2 _0953_ (.A1(_0284_),
    .A2(_0285_),
    .B1(\core_out[6] ),
    .X(_0287_));
 sky130_fd_sc_hd__and2b_2 _0954_ (.A_N(_0286_),
    .B(_0287_),
    .X(_0288_));
 sky130_fd_sc_hd__a21o_2 _0955_ (.A1(_0248_),
    .A2(_0250_),
    .B1(_0247_),
    .X(_0289_));
 sky130_fd_sc_hd__xnor2_2 _0956_ (.A(_0288_),
    .B(_0289_),
    .Y(_0290_));
 sky130_fd_sc_hd__nand2_2 _0957_ (.A(core_valid),
    .B(_0290_),
    .Y(_0291_));
 sky130_fd_sc_hd__o211a_2 _0958_ (.A1(core_valid),
    .A2(\core_out[6] ),
    .B1(_0083_),
    .C1(_0291_),
    .X(_0055_));
 sky130_fd_sc_hd__a21bo_2 _0959_ (.A1(_0245_),
    .A2(_0283_),
    .B1_N(_0282_),
    .X(_0292_));
 sky130_fd_sc_hd__a31o_2 _0960_ (.A1(\core_b[5] ),
    .A2(\core_a[1] ),
    .A3(_0259_),
    .B1(_0258_),
    .X(_0293_));
 sky130_fd_sc_hd__and4_2 _0961_ (.A(\core_b[6] ),
    .B(\core_b[5] ),
    .C(\core_a[2] ),
    .D(\core_a[1] ),
    .X(_0294_));
 sky130_fd_sc_hd__inv_2 _0962_ (.A(_0294_),
    .Y(_0295_));
 sky130_fd_sc_hd__a22o_2 _0963_ (.A1(\core_b[5] ),
    .A2(\core_a[2] ),
    .B1(\core_a[1] ),
    .B2(\core_b[6] ),
    .X(_0296_));
 sky130_fd_sc_hd__and4b_2 _0964_ (.A_N(\core_a[0] ),
    .B(_0295_),
    .C(_0296_),
    .D(\core_b[7] ),
    .X(_0297_));
 sky130_fd_sc_hd__o2bb2a_2 _0965_ (.A1_N(_0295_),
    .A2_N(_0296_),
    .B1(_0081_),
    .B2(\core_a[0] ),
    .X(_0298_));
 sky130_fd_sc_hd__nor2_2 _0966_ (.A(_0297_),
    .B(_0298_),
    .Y(_0299_));
 sky130_fd_sc_hd__nand2_2 _0967_ (.A(_0293_),
    .B(_0299_),
    .Y(_0300_));
 sky130_fd_sc_hd__xor2_2 _0968_ (.A(_0293_),
    .B(_0299_),
    .X(_0301_));
 sky130_fd_sc_hd__nand4_2 _0969_ (.A(\core_b[3] ),
    .B(\core_b[2] ),
    .C(\core_a[5] ),
    .D(\core_a[4] ),
    .Y(_0302_));
 sky130_fd_sc_hd__a22o_2 _0970_ (.A1(\core_b[2] ),
    .A2(\core_a[5] ),
    .B1(\core_a[4] ),
    .B2(\core_b[3] ),
    .X(_0303_));
 sky130_fd_sc_hd__nand2_2 _0971_ (.A(_0302_),
    .B(_0303_),
    .Y(_0304_));
 sky130_fd_sc_hd__xor2_2 _0972_ (.A(_0257_),
    .B(_0304_),
    .X(_0305_));
 sky130_fd_sc_hd__a21oi_2 _0973_ (.A1(\core_b[0] ),
    .A2(\core_a[7] ),
    .B1(\core_b[7] ),
    .Y(_0306_));
 sky130_fd_sc_hd__and3_2 _0974_ (.A(\core_b[7] ),
    .B(\core_b[0] ),
    .C(\core_a[7] ),
    .X(_0307_));
 sky130_fd_sc_hd__or3_2 _0975_ (.A(_0263_),
    .B(_0306_),
    .C(_0307_),
    .X(_0308_));
 sky130_fd_sc_hd__o21ai_2 _0976_ (.A1(_0306_),
    .A2(_0307_),
    .B1(_0263_),
    .Y(_0309_));
 sky130_fd_sc_hd__o211ai_2 _0977_ (.A1(_0264_),
    ...
    .C1(_0309_),
    .Y(_0310_));
 sky130_fd_sc_hd__a211o_2 _0978_ (.A1(_0308_),
    .A2(_0309_),
    .B1(_0264_),
    .C1(_0266_),
    .X(_0311_));
 sky130_fd_sc_hd__nand3_2 _0979_ (.A(_0305_),
    .B(_0310_),
    .C(_0311_),
    .Y(_0312_));
 sky130_fd_sc_hd__a21o_2 _0980_ (.A1(_0310_),
    .A2(_0311_),
    .B1(_0305_),
    .X(_0313_));
 sky130_fd_sc_hd__a21bo_2 _0981_ (.A1(_0261_),
    .A2(_0271_),
    .B1_N(_0270_),
    .X(_0314_));
 sky130_fd_sc_hd__nand3_2 _0982_ (.A(_0312_),
    ...
    .C(_0314_),
    .Y(_0315_));
 sky130_fd_sc_hd__a21o_2 _0983_ (.A1(_0312_),
    .A2(_0313_),
    .B1(_0314_),
    .X(_0316_));
 sky130_fd_sc_hd__and3_2 _0984_ (.A(_0301_),
    .B(_0315_),
    .C(_0316_),
    .X(_0317_));
 sky130_fd_sc_hd__nand3_2 _0985_ (.A(_0301_),
    .B(_0315_),
    .C(_0316_),
    .Y(_0318_));
 sky130_fd_sc_hd__a21oi_2 _0986_ (.A1(_0315_),
    .A2(_0316_),
    .B1(_0301_),
    .Y(_0319_));
 sky130_fd_sc_hd__a211o_2 _0987_ (.A1(_0275_),
    .A2(_0278_),
    .B1(_0317_),
    .C1(_0319_),
    .X(_0320_));
 ...
 sky130_fd_sc_hd__o211ai_2 _0989_ (.A1(_0317_),
    ...
    .C1(_0278_),
    .Y(_0322_));
 sky130_fd_sc_hd__and3_2 _0990_ (.A(_0253_),
    .B(_0320_),
    .C(_0322_),
    .X(_0323_));
 sky130_fd_sc_hd__nand3_2 _0991_ (.A(_0253_),
    .B(_0320_),
    .C(_0322_),
    .Y(_0324_));
 sky130_fd_sc_hd__a21o_2 _0992_ (.A1(_0320_),
    .A2(_0322_),
    .B1(_0253_),
    .X(_0325_));
 sky130_fd_sc_hd__nand3_2 _0993_ (.A(_0280_),
    .B(_0324_),
    .C(_0325_),
    .Y(_0326_));
 sky130_fd_sc_hd__a21o_2 _0994_ (.A1(_0324_),
    .A2(_0325_),
    .B1(_0280_),
    .X(_0327_));
 sky130_fd_sc_hd__nand3_2 _0995_ (.A(_0292_),
    .B(_0326_),
    .C(_0327_),
    .Y(_0328_));
 sky130_fd_sc_hd__a21o_2 _0996_ (.A1(_0326_),
    .A2(_0327_),
    .B1(_0292_),
    .X(_0329_));
 sky130_fd_sc_hd__and3_2 _0997_ (.A(\core_out[7] ),
    .B(_0328_),
    .C(_0329_),
    .X(_0330_));
 sky130_fd_sc_hd__a21oi_2 _0998_ (.A1(_0328_),
    .A2(_0329_),
    .B1(\core_out[7] ),
    .Y(_0331_));
 sky130_fd_sc_hd__a21oi_2 _0999_ (.A1(_0287_),
    ...
    .B1(_0286_),
    .Y(_0332_));
 sky130_fd_sc_hd__or3_2 _1000_ (.A(_0330_),
    .B(_0331_),
    .C(_0332_),
    .X(_0333_));
 sky130_fd_sc_hd__o21ai_2 _1001_ (.A1(_0330_),
    .A2(_0331_),
    .B1(_0332_),
    .Y(_0334_));
 sky130_fd_sc_hd__a21bo_2 _1002_ (.A1(_0333_),
    .A2(_0334_),
    .B1_N(core_valid),
    .X(_0335_));
 sky130_fd_sc_hd__o211a_2 _1003_ (.A1(core_valid),
    .A2(\core_out[7] ),
    .B1(_0083_),
    .C1(_0335_),
    .X(_0056_));
 sky130_fd_sc_hd__a21bo_2 _1004_ (.A1(_0292_),
    .A2(_0327_),
    .B1_N(_0326_),
    .X(_0336_));
 sky130_fd_sc_hd__nor2_2 _1005_ (.A(_0294_),
    .B(_0297_),
    .Y(_0337_));
 sky130_fd_sc_hd__o21ai_2 _1006_ (.A1(_0257_),
    .A2(_0304_),
    .B1(_0302_),
    .Y(_0338_));
 sky130_fd_sc_hd__o2bb2a_2 _1007_ (.A1_N(\core_b[6] ),
    .A2_N(\core_a[2] ),
    .B1(\core_a[1] ),
    .B2(_0081_),
    .X(_0339_));
 sky130_fd_sc_hd__and4b_2 _1008_ (.A_N(\core_a[1] ),
    .B(\core_a[2] ),
    .C(\core_b[6] ),
    .D(\core_b[7] ),
    .X(_0340_));
 sky130_fd_sc_hd__or2_2 _1009_ (.A(_0339_),
    .B(_0340_),
    .X(_0341_));
 sky130_fd_sc_hd__nand2b_2 _1010_ (.A_N(_0341_),
    .B(_0338_),
    .Y(_0342_));
 sky130_fd_sc_hd__xnor2_2 _1011_ (.A(_0338_),
    .B(_0341_),
    .Y(_0343_));
 sky130_fd_sc_hd__nand2b_2 _1012_ (.A_N(_0337_),
    .B(_0343_),
    .Y(_0344_));
 sky130_fd_sc_hd__xnor2_2 _1013_ (.A(_0337_),
    .B(_0343_),
    .Y(_0345_));
 sky130_fd_sc_hd__nand2_2 _1014_ (.A(\core_b[5] ),
    .B(\core_a[3] ),
    .Y(_0346_));
 sky130_fd_sc_hd__and4_2 _1015_ (.A(\core_b[4] ),
    .B(\core_b[3] ),
    .C(\core_a[5] ),
    .D(\core_a[4] ),
    .X(_0347_));
 sky130_fd_sc_hd__a22o_2 _1016_ (.A1(\core_b[3] ),
    .A2(\core_a[5] ),
    .B1(\core_a[4] ),
    .B2(\core_b[4] ),
    .X(_0348_));
 sky130_fd_sc_hd__and2b_2 _1017_ (.A_N(_0347_),
    .B(_0348_),
    .X(_0349_));
 sky130_fd_sc_hd__xnor2_2 _1018_ (.A(_0346_),
    .B(_0349_),
    .Y(_0350_));
 sky130_fd_sc_hd__and3_2 _1019_ (.A(\core_b[1] ),
    .B(\core_b[0] ),
    .C(\core_a[7] ),
    .X(_0351_));
 sky130_fd_sc_hd__o21ai_2 _1020_ (.A1(\core_b[1] ),
    .A2(\core_b[0] ),
    .B1(\core_a[7] ),
    .Y(_0352_));
 sky130_fd_sc_hd__o21a_2 _1021_ (.A1(\core_b[1] ),
    .A2(\core_b[0] ),
    .B1(\core_a[7] ),
    .X(_0353_));
 sky130_fd_sc_hd__a2bb2o_2 _1022_ (.A1_N(_0351_),
    .A2_N(_0352_),
    .B1(\core_b[2] ),
    .B2(\core_a[6] ),
    .X(_0354_));
 sky130_fd_sc_hd__or4bb_2 _1023_ (.A(_0351_),
    .B(_0352_),
    .C_N(\core_b[2] ),
    .D_N(\core_a[6] ),
    .X(_0355_));
 sky130_fd_sc_hd__o21bai_2 _1024_ (.A1(_0263_),
    .A2(_0306_),
    .B1_N(_0307_),
    .Y(_0356_));
 sky130_fd_sc_hd__nand3_2 _1025_ (.A(_0354_),
    .B(_0355_),
    .C(_0356_),
    .Y(_0357_));
 sky130_fd_sc_hd__a21o_2 _1026_ (.A1(_0354_),
    .A2(_0355_),
    .B1(_0356_),
    .X(_0358_));
 sky130_fd_sc_hd__nand3_2 _1027_ (.A(_0350_),
    .B(_0357_),
    .C(_0358_),
    .Y(_0359_));
 sky130_fd_sc_hd__a21o_2 _1028_ (.A1(_0357_),
    .A2(_0358_),
    .B1(_0350_),
    .X(_0360_));
 sky130_fd_sc_hd__a21bo_2 _1029_ (.A1(_0305_),
    .A2(_0311_),
    .B1_N(_0310_),
    .X(_0361_));
 sky130_fd_sc_hd__nand3_2 _1030_ (.A(_0359_),
    ...
    .C(_0361_),
    .Y(_0362_));
 sky130_fd_sc_hd__a21o_2 _1031_ (.A1(_0359_),
    .A2(_0360_),
    .B1(_0361_),
    .X(_0363_));
 sky130_fd_sc_hd__and3_2 _1032_ (.A(_0345_),
    .B(_0362_),
    .C(_0363_),
    .X(_0364_));
 sky130_fd_sc_hd__nand3_2 _1033_ (.A(_0345_),
    .B(_0362_),
    .C(_0363_),
    .Y(_0365_));
 sky130_fd_sc_hd__a21oi_2 _1034_ (.A1(_0362_),
    .A2(_0363_),
    .B1(_0345_),
    .Y(_0366_));
 sky130_fd_sc_hd__a211oi_2 _1035_ (.A1(_0315_),
    .A2(_0318_),
    .B1(_0364_),
    .C1(_0366_),
    .Y(_0367_));
 sky130_fd_sc_hd__a211o_2 _1036_ (.A1(_0315_),
    .A2(_0318_),
    .B1(_0364_),
    .C1(_0366_),
    .X(_0368_));
 sky130_fd_sc_hd__o211a_2 _1037_ (.A1(_0364_),
    .A2(_0366_),
    .B1(_0315_),
    .C1(_0318_),
    .X(_0369_));
 sky130_fd_sc_hd__or3_2 _1038_ (.A(_0300_),
    ...
    .C(_0369_),
    .X(_0370_));
 sky130_fd_sc_hd__o21ai_2 _1039_ (.A1(_0367_),
    .A2(_0369_),
    .B1(_0300_),
    .Y(_0371_));
 sky130_fd_sc_hd__o211a_2 _1040_ (.A1(_0321_),
    .A2(_0323_),
    .B1(_0370_),
    .C1(_0371_),
    .X(_0372_));
 sky130_fd_sc_hd__a211o_2 _1041_ (.A1(_0370_),
    .A2(_0371_),
    .B1(_0321_),
    .C1(_0323_),
    .X(_0373_));
 sky130_fd_sc_hd__and2b_2 _1042_ (.A_N(_0372_),
    .B(_0373_),
    .X(_0374_));
 sky130_fd_sc_hd__xor2_2 _1043_ (.A(_0336_),
    .B(_0374_),
    .X(_0375_));
 sky130_fd_sc_hd__and2_2 _1044_ (.A(\core_out[8] ),
    .B(_0375_),
    .X(_0376_));
 sky130_fd_sc_hd__or2_2 _1045_ (.A(\core_out[8] ),
    .B(_0375_),
    .X(_0377_));
 sky130_fd_sc_hd__nand2b_2 _1046_ (.A_N(_0376_),
    .B(_0377_),
    .Y(_0378_));
 sky130_fd_sc_hd__o21bai_2 _1047_ (.A1(_0331_),
    ...
    .B1_N(_0330_),
    .Y(_0379_));
 sky130_fd_sc_hd__xnor2_2 _1048_ (.A(_0378_),
    .B(_0379_),
    .Y(_0380_));
 sky130_fd_sc_hd__mux2_1 _1049_ (.A0(\core_out[8] ),
    ...
    .S(core_valid),
    .X(_0381_));
 sky130_fd_sc_hd__and2_2 _1050_ (.A(_0083_),
    .B(_0381_),
    .X(_0057_));
 sky130_fd_sc_hd__a21oi_2 _1051_ (.A1(_0377_),
    ...
    .B1(_0376_),
    .Y(_0382_));
 sky130_fd_sc_hd__a31o_2 _1052_ (.A1(\core_b[5] ),
    .A2(\core_a[3] ),
    .A3(_0348_),
    .B1(_0347_),
    .X(_0383_));
 sky130_fd_sc_hd__o2bb2a_2 _1053_ (.A1_N(\core_b[6] ),
    .A2_N(\core_a[3] ),
    .B1(\core_a[2] ),
    .B2(_0081_),
    .X(_0384_));
 sky130_fd_sc_hd__and4b_2 _1054_ (.A_N(\core_a[2] ),
    .B(\core_a[3] ),
    .C(\core_b[6] ),
    .D(\core_b[7] ),
    .X(_0385_));
 sky130_fd_sc_hd__nor2_2 _1055_ (.A(_0384_),
    .B(_0385_),
    .Y(_0386_));
 sky130_fd_sc_hd__and2_2 _1056_ (.A(_0383_),
    .B(_0386_),
    .X(_0387_));
 sky130_fd_sc_hd__xor2_2 _1057_ (.A(_0383_),
    .B(_0386_),
    .X(_0388_));
 sky130_fd_sc_hd__xor2_2 _1058_ (.A(_0340_),
    .B(_0388_),
    .X(_0389_));
 sky130_fd_sc_hd__nand2_2 _1059_ (.A(\core_b[5] ),
    .B(\core_a[4] ),
    .Y(_0390_));
 sky130_fd_sc_hd__and4_2 _1060_ (.A(\core_b[4] ),
    .B(\core_b[3] ),
    .C(\core_a[6] ),
    .D(\core_a[5] ),
    .X(_0391_));
 sky130_fd_sc_hd__a22o_2 _1061_ (.A1(\core_b[3] ),
    .A2(\core_a[6] ),
    .B1(\core_a[5] ),
    .B2(\core_b[4] ),
    .X(_0392_));
 sky130_fd_sc_hd__and2b_2 _1062_ (.A_N(_0391_),
    .B(_0392_),
    .X(_0393_));
 sky130_fd_sc_hd__xnor2_2 _1063_ (.A(_0390_),
    .B(_0393_),
    .Y(_0394_));
 sky130_fd_sc_hd__or3b_2 _1064_ (.A(_0351_),
    .B(_0352_),
    .C_N(\core_b[2] ),
    .X(_0395_));
 sky130_fd_sc_hd__a2bb2o_2 _1065_ (.A1_N(_0351_),
    .A2_N(_0352_),
    .B1(\core_b[2] ),
    .B2(\core_a[7] ),
    .X(_0396_));
 sky130_fd_sc_hd__a31o_2 _1066_ (.A1(\core_b[2] ),
    .A2(\core_a[6] ),
    .A3(_0353_),
    .B1(_0351_),
    .X(_0397_));
 sky130_fd_sc_hd__and2_2 _1067_ (.A(\core_b[2] ),
    .B(_0351_),
    .X(_0398_));
 sky130_fd_sc_hd__nand2_2 _1068_ (.A(\core_b[2] ),
    .B(_0351_),
    .Y(_0399_));
 sky130_fd_sc_hd__a21o_2 _1069_ (.A1(_0395_),
    .A2(_0396_),
    .B1(_0397_),
    .X(_0400_));
 sky130_fd_sc_hd__and3_2 _1070_ (.A(_0394_),
    .B(_0399_),
    .C(_0400_),
    .X(_0401_));
 sky130_fd_sc_hd__a21oi_2 _1071_ (.A1(_0399_),
    .A2(_0400_),
    .B1(_0394_),
    .Y(_0402_));
 sky130_fd_sc_hd__a21bo_2 _1072_ (.A1(_0350_),
    .A2(_0358_),
    .B1_N(_0357_),
    .X(_0403_));
 sky130_fd_sc_hd__or3b_2 _1073_ (.A(_0401_),
    .B(_0402_),
    .C_N(_0403_),
    .X(_0404_));
 sky130_fd_sc_hd__o21bai_2 _1074_ (.A1(_0401_),
    .A2(_0402_),
    .B1_N(_0403_),
    .Y(_0405_));
 sky130_fd_sc_hd__and3_2 _1075_ (.A(_0389_),
    .B(_0404_),
    .C(_0405_),
    .X(_0406_));
 sky130_fd_sc_hd__a21oi_2 _1076_ (.A1(_0404_),
    .A2(_0405_),
    .B1(_0389_),
    .Y(_0407_));
 sky130_fd_sc_hd__a211oi_2 _1077_ (.A1(_0362_),
    ...
    .C1(_0407_),
    .Y(_0408_));
 sky130_fd_sc_hd__o211a_2 _1078_ (.A1(_0406_),
    .A2(_0407_),
    .B1(_0362_),
    .C1(_0365_),
    .X(_0409_));
 sky130_fd_sc_hd__a211oi_2 _1079_ (.A1(_0342_),
    ...
    .C1(_0409_),
    .Y(_0410_));
 sky130_fd_sc_hd__o211a_2 _1080_ (.A1(_0408_),
    .A2(_0409_),
    .B1(_0342_),
    .C1(_0344_),
    .X(_0411_));
 sky130_fd_sc_hd__o211ai_2 _1081_ (.A1(_0410_),
    ...
    .C1(_0370_),
    .Y(_0412_));
 sky130_fd_sc_hd__a211o_2 _1082_ (.A1(_0368_),
    .A2(_0370_),
    .B1(_0410_),
    .C1(_0411_),
    .X(_0413_));
 sky130_fd_sc_hd__nand2_2 _1083_ (.A(_0412_),
    .B(_0413_),
    .Y(_0414_));
 sky130_fd_sc_hd__a21o_2 _1084_ (.A1(_0336_),
    .A2(_0374_),
    .B1(_0372_),
    .X(_0415_));
 sky130_fd_sc_hd__xnor2_2 _1085_ (.A(_0414_),
    .B(_0415_),
    .Y(_0416_));
 sky130_fd_sc_hd__nand2_2 _1086_ (.A(\core_out[9] ),
    .B(_0416_),
    .Y(_0417_));
 sky130_fd_sc_hd__inv_2 _1087_ (.A(_0417_),
    .Y(_0418_));
 sky130_fd_sc_hd__nor2_2 _1088_ (.A(\core_out[9] ),
    .B(_0416_),
    .Y(_0419_));
 sky130_fd_sc_hd__o21a_2 _1089_ (.A1(_0418_),
    .A2(_0419_),
    .B1(_0382_),
    .X(_0420_));
 sky130_fd_sc_hd__nor3_2 _1090_ (.A(_0382_),
    .B(_0418_),
    .C(_0419_),
    .Y(_0421_));
 sky130_fd_sc_hd__o21ai_2 _1091_ (.A1(_0420_),
    .A2(_0421_),
    .B1(core_valid),
    .Y(_0422_));
 sky130_fd_sc_hd__o211a_2 _1092_ (.A1(core_valid),
    .A2(\core_out[9] ),
    .B1(_0083_),
    .C1(_0422_),
    .X(_0058_));
 sky130_fd_sc_hd__a21oi_2 _1093_ (.A1(_0340_),
    .A2(_0388_),
    .B1(_0387_),
    .Y(_0423_));
 sky130_fd_sc_hd__a31o_2 _1094_ (.A1(\core_b[5] ),
    .A2(\core_a[4] ),
    .A3(_0392_),
    .B1(_0391_),
    .X(_0424_));
 sky130_fd_sc_hd__o2bb2a_2 _1095_ (.A1_N(\core_b[6] ),
    .A2_N(\core_a[4] ),
    .B1(\core_a[3] ),
    .B2(_0081_),
    .X(_0425_));
 sky130_fd_sc_hd__and4b_2 _1096_ (.A_N(\core_a[3] ),
    .B(\core_a[4] ),
    .C(\core_b[6] ),
    .D(\core_b[7] ),
    .X(_0426_));
 sky130_fd_sc_hd__nor2_2 _1097_ (.A(_0425_),
    .B(_0426_),
    .Y(_0427_));
 sky130_fd_sc_hd__and2_2 _1098_ (.A(_0424_),
    .B(_0427_),
    .X(_0428_));
 sky130_fd_sc_hd__xor2_2 _1099_ (.A(_0424_),
    .B(_0427_),
    .X(_0429_));
 sky130_fd_sc_hd__xnor2_2 _1100_ (.A(_0385_),
    .B(_0429_),
    .Y(_0430_));
 sky130_fd_sc_hd__a21oi_2 _1101_ (.A1(\core_b[2] ),
    .A2(\core_a[7] ),
    .B1(_0353_),
    .Y(_0431_));
 sky130_fd_sc_hd__nor2_2 _1102_ (.A(_0398_),
    .B(_0431_),
    .Y(_0432_));
 sky130_fd_sc_hd__a22o_2 _1103_ (.A1(\core_b[3] ),
    .A2(\core_a[7] ),
    .B1(\core_a[6] ),
    .B2(\core_b[4] ),
    .X(_0433_));
 sky130_fd_sc_hd__and3_2 _1104_ (.A(\core_b[4] ),
    .B(\core_b[3] ),
    .C(\core_a[7] ),
    .X(_0434_));
 sky130_fd_sc_hd__nand3_2 _1105_ (.A(\core_b[4] ),
    .B(\core_b[3] ),
    .C(\core_a[7] ),
    .Y(_0435_));
 sky130_fd_sc_hd__nand4_2 _1106_ (.A(\core_b[4] ),
    .B(\core_b[3] ),
    .C(\core_a[7] ),
    .D(\core_a[6] ),
    .Y(_0436_));
 sky130_fd_sc_hd__nand4_2 _1107_ (.A(\core_b[5] ),
    .B(\core_a[5] ),
    .C(_0433_),
    .D(_0436_),
    .Y(_0437_));
 sky130_fd_sc_hd__a22o_2 _1108_ (.A1(\core_b[5] ),
    .A2(\core_a[5] ),
    .B1(_0433_),
    .B2(_0436_),
    .X(_0438_));
 sky130_fd_sc_hd__nand2_2 _1109_ (.A(_0437_),
    .B(_0438_),
    .Y(_0439_));
 sky130_fd_sc_hd__xnor2_2 _1110_ (.A(_0432_),
    .B(_0439_),
    .Y(_0440_));
 sky130_fd_sc_hd__a21oi_2 _1111_ (.A1(_0394_),
    .A2(_0400_),
    .B1(_0398_),
    .Y(_0441_));
 sky130_fd_sc_hd__nand2b_2 _1112_ (.A_N(_0441_),
    .B(_0440_),
    .Y(_0442_));
 sky130_fd_sc_hd__and2b_2 _1113_ (.A_N(_0440_),
    .B(_0441_),
    .X(_0443_));
 sky130_fd_sc_hd__xnor2_2 _1114_ (.A(_0440_),
    .B(_0441_),
    .Y(_0444_));
 sky130_fd_sc_hd__xnor2_2 _1115_ (.A(_0430_),
    .B(_0444_),
    .Y(_0445_));
 sky130_fd_sc_hd__a21boi_2 _1116_ (.A1(_0389_),
    .A2(_0405_),
    .B1_N(_0404_),
    .Y(_0446_));
 sky130_fd_sc_hd__nand2b_2 _1117_ (.A_N(_0446_),
    .B(_0445_),
    .Y(_0447_));
 sky130_fd_sc_hd__xnor2_2 _1118_ (.A(_0445_),
    .B(_0446_),
    .Y(_0448_));
 sky130_fd_sc_hd__nand2b_2 _1119_ (.A_N(_0423_),
    .B(_0448_),
    .Y(_0449_));
 sky130_fd_sc_hd__xnor2_2 _1120_ (.A(_0423_),
    .B(_0448_),
    .Y(_0450_));
 sky130_fd_sc_hd__or3_2 _1121_ (.A(_0408_),
    .B(_0410_),
    .C(_0450_),
    .X(_0451_));
 sky130_fd_sc_hd__o21a_2 _1122_ (.A1(_0408_),
    .A2(_0410_),
    .B1(_0450_),
    .X(_0452_));
 sky130_fd_sc_hd__o21ai_2 _1123_ (.A1(_0408_),
    .A2(_0410_),
    .B1(_0450_),
    .Y(_0453_));
 sky130_fd_sc_hd__nand2_2 _1124_ (.A(_0451_),
    .B(_0453_),
    .Y(_0454_));
 sky130_fd_sc_hd__and4b_2 _1125_ (.A_N(_0372_),
    .B(_0373_),
    .C(_0412_),
    .D(_0413_),
    .X(_0455_));
 sky130_fd_sc_hd__a21bo_2 _1126_ (.A1(_0372_),
    .A2(_0412_),
    .B1_N(_0413_),
    .X(_0456_));
 sky130_fd_sc_hd__a21o_2 _1127_ (.A1(_0336_),
    .A2(_0455_),
    .B1(_0456_),
    .X(_0457_));
 sky130_fd_sc_hd__xnor2_2 _1128_ (.A(_0454_),
    .B(_0457_),
    .Y(_0458_));
 sky130_fd_sc_hd__nand2_2 _1129_ (.A(\core_out[10] ),
    .B(_0458_),
    .Y(_0459_));
 sky130_fd_sc_hd__xnor2_2 _1130_ (.A(\core_out[10] ),
    .B(_0458_),
    .Y(_0460_));
 sky130_fd_sc_hd__a21o_2 _1131_ (.A1(_0382_),
    .A2(_0417_),
    .B1(_0419_),
    .X(_0461_));
 sky130_fd_sc_hd__a211o_2 _1132_ (.A1(_0382_),
    .A2(_0417_),
    .B1(_0419_),
    .C1(_0460_),
    .X(_0462_));
 sky130_fd_sc_hd__xnor2_2 _1133_ (.A(_0460_),
    .B(_0461_),
    .Y(_0463_));
 sky130_fd_sc_hd__nand2_2 _1134_ (.A(core_valid),
    .B(_0463_),
    .Y(_0464_));
 sky130_fd_sc_hd__o211a_2 _1135_ (.A1(core_valid),
    .A2(\core_out[10] ),
    .B1(_0083_),
    .C1(_0464_),
    .X(_0059_));
 sky130_fd_sc_hd__a21o_2 _1136_ (.A1(_0385_),
    .A2(_0429_),
    .B1(_0428_),
    .X(_0465_));
 sky130_fd_sc_hd__nand2_2 _1137_ (.A(_0436_),
    .B(_0437_),
    .Y(_0466_));
 sky130_fd_sc_hd__and4b_2 _1138_ (.A_N(\core_a[4] ),
    .B(\core_a[5] ),
    .C(\core_b[6] ),
    .D(\core_b[7] ),
    .X(_0467_));
 sky130_fd_sc_hd__o2bb2a_2 _1139_ (.A1_N(\core_b[6] ),
    .A2_N(\core_a[5] ),
    .B1(\core_a[4] ),
    .B2(_0081_),
    .X(_0468_));
 sky130_fd_sc_hd__nor2_2 _1140_ (.A(_0467_),
    .B(_0468_),
    .Y(_0469_));
 sky130_fd_sc_hd__xor2_2 _1141_ (.A(_0466_),
    .B(_0469_),
    .X(_0470_));
 sky130_fd_sc_hd__nand2_2 _1142_ (.A(_0426_),
    .B(_0470_),
    .Y(_0471_));
 sky130_fd_sc_hd__xnor2_2 _1143_ (.A(_0426_),
    .B(_0470_),
    .Y(_0472_));
 sky130_fd_sc_hd__o21a_2 _1144_ (.A1(\core_b[4] ),
    .A2(\core_b[3] ),
    .B1(\core_a[7] ),
    .X(_0473_));
 sky130_fd_sc_hd__and2_2 _1145_ (.A(_0435_),
    .B(_0473_),
    .X(_0474_));
 sky130_fd_sc_hd__nand2_2 _1146_ (.A(\core_b[5] ),
    .B(\core_a[6] ),
    .Y(_0475_));
 sky130_fd_sc_hd__xor2_2 _1147_ (.A(_0474_),
    .B(_0475_),
    .X(_0476_));
 sky130_fd_sc_hd__xnor2_2 _1148_ (.A(_0432_),
    .B(_0476_),
    .Y(_0477_));
 sky130_fd_sc_hd__o21ai_2 _1149_ (.A1(_0431_),
    .A2(_0439_),
    .B1(_0399_),
    .Y(_0478_));
 sky130_fd_sc_hd__nand2_2 _1150_ (.A(_0477_),
    .B(_0478_),
    .Y(_0479_));
 sky130_fd_sc_hd__xnor2_2 _1151_ (.A(_0477_),
    .B(_0478_),
    .Y(_0480_));
 sky130_fd_sc_hd__or2_2 _1152_ (.A(_0472_),
    .B(_0480_),
    .X(_0481_));
 sky130_fd_sc_hd__xor2_2 _1153_ (.A(_0472_),
    .B(_0480_),
    .X(_0482_));
 sky130_fd_sc_hd__o21ai_2 _1154_ (.A1(_0430_),
    .A2(_0443_),
    .B1(_0442_),
    .Y(_0483_));
 sky130_fd_sc_hd__and2_2 _1155_ (.A(_0482_),
    .B(_0483_),
    .X(_0484_));
 sky130_fd_sc_hd__xor2_2 _1156_ (.A(_0482_),
    .B(_0483_),
    .X(_0485_));
 sky130_fd_sc_hd__xnor2_2 _1157_ (.A(_0465_),
    .B(_0485_),
    .Y(_0486_));
 sky130_fd_sc_hd__a21oi_2 _1158_ (.A1(_0447_),
    .A2(_0449_),
    .B1(_0486_),
    .Y(_0487_));
 sky130_fd_sc_hd__nand3_2 _1159_ (.A(_0447_),
    .B(_0449_),
    .C(_0486_),
    .Y(_0488_));
 sky130_fd_sc_hd__nand2b_2 _1160_ (.A_N(_0487_),
    .B(_0488_),
    .Y(_0489_));
 sky130_fd_sc_hd__a21o_2 _1161_ (.A1(_0451_),
    .A2(_0457_),
    .B1(_0452_),
    .X(_0490_));
 sky130_fd_sc_hd__xnor2_2 _1162_ (.A(_0489_),
    .B(_0490_),
    .Y(_0491_));
 sky130_fd_sc_hd__and2_2 _1163_ (.A(\core_out[11] ),
    .B(_0491_),
    .X(_0492_));
 sky130_fd_sc_hd__xnor2_2 _1164_ (.A(\core_out[11] ),
    .B(_0491_),
    .Y(_0493_));
 sky130_fd_sc_hd__a21oi_2 _1165_ (.A1(_0459_),
    ...
    .B1(_0493_),
    .Y(_0494_));
 sky130_fd_sc_hd__and3_2 _1166_ (.A(_0459_),
    .B(_0462_),
    .C(_0493_),
    .X(_0495_));
 sky130_fd_sc_hd__o21ai_2 _1167_ (.A1(_0494_),
    .A2(_0495_),
    .B1(core_valid),
    .Y(_0496_));
 sky130_fd_sc_hd__o211a_2 _1168_ (.A1(core_valid),
    .A2(\core_out[11] ),
    .B1(_0083_),
    .C1(_0496_),
    .X(_0060_));
 sky130_fd_sc_hd__nor2_2 _1169_ (.A(_0492_),
    .B(_0494_),
    .Y(_0497_));
 sky130_fd_sc_hd__a21bo_2 _1170_ (.A1(_0466_),
    .A2(_0469_),
    .B1_N(_0471_),
    .X(_0498_));
 sky130_fd_sc_hd__a22oi_2 _1171_ (.A1(\core_b[5] ),
    .A2(\core_a[7] ),
    .B1(_0435_),
    .B2(_0473_),
    .Y(_0499_));
 sky130_fd_sc_hd__a21oi_2 _1172_ (.A1(\core_b[5] ),
    .A2(_0474_),
    .B1(_0499_),
    .Y(_0500_));
 sky130_fd_sc_hd__xor2_2 _1173_ (.A(_0432_),
    .B(_0500_),
    .X(_0501_));
 sky130_fd_sc_hd__o21ai_2 _1174_ (.A1(_0431_),
    .A2(_0476_),
    .B1(_0399_),
    .Y(_0502_));
 sky130_fd_sc_hd__and2_2 _1175_ (.A(_0501_),
    .B(_0502_),
    .X(_0503_));
 sky130_fd_sc_hd__xnor2_2 _1176_ (.A(_0501_),
    .B(_0502_),
    .Y(_0504_));
 sky130_fd_sc_hd__a31o_2 _1177_ (.A1(\core_b[5] ),
    .A2(\core_a[6] ),
    .A3(_0473_),
    .B1(_0434_),
    .X(_0505_));
 sky130_fd_sc_hd__o2bb2a_2 _1178_ (.A1_N(\core_b[6] ),
    .A2_N(\core_a[6] ),
    .B1(\core_a[5] ),
    .B2(_0081_),
    .X(_0506_));
 sky130_fd_sc_hd__and4b_2 _1179_ (.A_N(\core_a[5] ),
    .B(\core_a[6] ),
    .C(\core_b[6] ),
    .D(\core_b[7] ),
    .X(_0507_));
 sky130_fd_sc_hd__nor2_2 _1180_ (.A(_0506_),
    .B(_0507_),
    .Y(_0508_));
 sky130_fd_sc_hd__and2_2 _1181_ (.A(_0505_),
    .B(_0508_),
    .X(_0509_));
 sky130_fd_sc_hd__xor2_2 _1182_ (.A(_0505_),
    .B(_0508_),
    .X(_0510_));
 sky130_fd_sc_hd__xnor2_2 _1183_ (.A(_0467_),
    .B(_0510_),
    .Y(_0511_));
 sky130_fd_sc_hd__nor2_2 _1184_ (.A(_0504_),
    .B(_0511_),
    .Y(_0512_));
 sky130_fd_sc_hd__xnor2_2 _1185_ (.A(_0504_),
    .B(_0511_),
    .Y(_0513_));
 sky130_fd_sc_hd__a21oi_2 _1186_ (.A1(_0479_),
    .A2(_0481_),
    .B1(_0513_),
    .Y(_0514_));
 sky130_fd_sc_hd__and3_2 _1187_ (.A(_0479_),
    .B(_0481_),
    .C(_0513_),
    .X(_0515_));
 sky130_fd_sc_hd__nor2_2 _1188_ (.A(_0514_),
    .B(_0515_),
    .Y(_0516_));
 sky130_fd_sc_hd__xnor2_2 _1189_ (.A(_0498_),
    .B(_0516_),
    .Y(_0517_));
 sky130_fd_sc_hd__a21o_2 _1190_ (.A1(_0465_),
    .A2(_0485_),
    .B1(_0484_),
    .X(_0518_));
 sky130_fd_sc_hd__and2b_2 _1191_ (.A_N(_0517_),
    .B(_0518_),
    .X(_0519_));
 sky130_fd_sc_hd__xor2_2 _1192_ (.A(_0517_),
    .B(_0518_),
    .X(_0520_));
 sky130_fd_sc_hd__inv_2 _1193_ (.A(_0520_),
    .Y(_0521_));
 sky130_fd_sc_hd__a21o_2 _1194_ (.A1(_0451_),
    .A2(_0488_),
    .B1(_0487_),
    .X(_0522_));
 sky130_fd_sc_hd__a21o_2 _1195_ (.A1(_0452_),
    .A2(_0488_),
    .B1(_0487_),
    .X(_0523_));
 sky130_fd_sc_hd__a211o_2 _1196_ (.A1(_0336_),
    .A2(_0455_),
    .B1(_0456_),
    .C1(_0523_),
    .X(_0524_));
 sky130_fd_sc_hd__nand2_2 _1197_ (.A(_0522_),
    .B(_0524_),
    .Y(_0525_));
 sky130_fd_sc_hd__xnor2_2 _1198_ (.A(_0521_),
    .B(_0525_),
    .Y(_0526_));
 sky130_fd_sc_hd__and2_2 _1199_ (.A(\core_out[12] ),
    .B(_0526_),
    .X(_0527_));
 sky130_fd_sc_hd__xnor2_2 _1200_ (.A(\core_out[12] ),
    .B(_0526_),
    .Y(_0528_));
 sky130_fd_sc_hd__xnor2_2 _1201_ (.A(_0497_),
    .B(_0528_),
    .Y(_0529_));
 sky130_fd_sc_hd__nand2_2 _1202_ (.A(core_valid),
    .B(_0529_),
    .Y(_0530_));
 sky130_fd_sc_hd__o211a_2 _1203_ (.A1(core_valid),
    .A2(\core_out[12] ),
    .B1(_0083_),
    .C1(_0530_),
    .X(_0061_));
 sky130_fd_sc_hd__and2_2 _1204_ (.A(_0398_),
    .B(_0500_),
    .X(_0531_));
 sky130_fd_sc_hd__nor3_2 _1205_ (.A(_0398_),
    .B(_0432_),
    .C(_0500_),
    .Y(_0532_));
 sky130_fd_sc_hd__nor2_2 _1206_ (.A(_0531_),
    .B(_0532_),
    .Y(_0533_));
 sky130_fd_sc_hd__a21oi_2 _1207_ (.A1(\core_b[5] ),
    .A2(_0473_),
    .B1(_0434_),
    .Y(_0534_));
 sky130_fd_sc_hd__inv_2 _1208_ (.A(_0534_),
    .Y(_0535_));
 sky130_fd_sc_hd__o2bb2a_2 _1209_ (.A1_N(\core_b[6] ),
    .A2_N(\core_a[7] ),
    .B1(\core_a[6] ),
    .B2(_0081_),
    .X(_0536_));
 sky130_fd_sc_hd__and4b_2 _1210_ (.A_N(\core_a[6] ),
    .B(\core_a[7] ),
    .C(\core_b[6] ),
    .D(\core_b[7] ),
    .X(_0537_));
 sky130_fd_sc_hd__nor2_2 _1211_ (.A(_0536_),
    .B(_0537_),
    .Y(_0538_));
 sky130_fd_sc_hd__xnor2_2 _1212_ (.A(_0534_),
    .B(_0538_),
    .Y(_0539_));
 sky130_fd_sc_hd__and2_2 _1213_ (.A(_0507_),
    .B(_0539_),
    .X(_0540_));
 sky130_fd_sc_hd__xnor2_2 _1214_ (.A(_0507_),
    .B(_0539_),
    .Y(_0541_));
 sky130_fd_sc_hd__nor3_2 _1215_ (.A(_0531_),
    .B(_0532_),
    .C(_0541_),
    .Y(_0542_));
 sky130_fd_sc_hd__xnor2_2 _1216_ (.A(_0533_),
    .B(_0541_),
    .Y(_0543_));
 sky130_fd_sc_hd__o21ai_2 _1217_ (.A1(_0503_),
    .A2(_0512_),
    .B1(_0543_),
    .Y(_0544_));
 sky130_fd_sc_hd__or3_2 _1218_ (.A(_0503_),
    .B(_0512_),
    .C(_0543_),
    .X(_0545_));
 sky130_fd_sc_hd__nand2_2 _1219_ (.A(_0544_),
    .B(_0545_),
    .Y(_0546_));
 ...
 sky130_fd_sc_hd__xor2_2 _1221_ (.A(_0546_),
    .B(_0547_),
    .X(_0548_));
 sky130_fd_sc_hd__a21oi_2 _1222_ (.A1(_0498_),
    .A2(_0516_),
    .B1(_0514_),
    .Y(_0549_));
 sky130_fd_sc_hd__and2b_2 _1223_ (.A_N(_0549_),
    .B(_0548_),
    .X(_0550_));
 sky130_fd_sc_hd__xnor2_2 _1224_ (.A(_0548_),
    .B(_0549_),
    .Y(_0551_));
 sky130_fd_sc_hd__a31o_2 _1225_ (.A1(_0521_),
    .A2(_0522_),
    .A3(_0524_),
    .B1(_0519_),
    .X(_0552_));
 sky130_fd_sc_hd__and2b_2 _1226_ (.A_N(_0520_),
    .B(_0551_),
    .X(_0553_));
 sky130_fd_sc_hd__xor2_2 _1227_ (.A(_0551_),
    .B(_0552_),
    .X(_0554_));
 sky130_fd_sc_hd__xor2_2 _1228_ (.A(\core_out[13] ),
    .B(_0554_),
    .X(_0555_));
 sky130_fd_sc_hd__o21bai_2 _1229_ (.A1(_0497_),
    .A2(_0528_),
    .B1_N(_0527_),
    .Y(_0556_));
 sky130_fd_sc_hd__xnor2_2 _1230_ (.A(_0555_),
    .B(_0556_),
    .Y(_0557_));
 sky130_fd_sc_hd__nand2_2 _1231_ (.A(core_valid),
    .B(_0557_),
    .Y(_0558_));
 sky130_fd_sc_hd__o211a_2 _1232_ (.A1(core_valid),
    .A2(\core_out[13] ),
    .B1(_0083_),
    .C1(_0558_),
    .X(_0062_));
 sky130_fd_sc_hd__a21o_2 _1233_ (.A1(_0519_),
    .A2(_0551_),
    .B1(_0550_),
    .X(_0559_));
 sky130_fd_sc_hd__a31o_2 _1234_ (.A1(_0522_),
    .A2(_0524_),
    .A3(_0553_),
    .B1(_0559_),
    .X(_0560_));
 sky130_fd_sc_hd__a21o_2 _1235_ (.A1(_0535_),
    .A2(_0538_),
    .B1(_0540_),
    .X(_0561_));
 sky130_fd_sc_hd__mux2_1 _1236_ (.A0(\core_b[7] ),
    .A1(\core_b[6] ),
    .S(\core_a[7] ),
    .X(_0562_));
 sky130_fd_sc_hd__xor2_2 _1237_ (.A(_0534_),
    .B(_0562_),
    .X(_0563_));
 sky130_fd_sc_hd__a21oi_2 _1238_ (.A1(_0535_),
    .A2(_0562_),
    .B1(_0537_),
    .Y(_0564_));
 sky130_fd_sc_hd__mux2_1 _1239_ (.A0(_0563_),
    ...
    .S(_0537_),
    .X(_0565_));
 sky130_fd_sc_hd__xor2_2 _1240_ (.A(_0533_),
    .B(_0565_),
    .X(_0566_));
 sky130_fd_sc_hd__o21ba_2 _1241_ (.A1(_0531_),
    .A2(_0542_),
    .B1_N(_0566_),
    .X(_0567_));
 sky130_fd_sc_hd__or3b_2 _1242_ (.A(_0531_),
    .B(_0542_),
    .C_N(_0566_),
    .X(_0568_));
 sky130_fd_sc_hd__and2b_2 _1243_ (.A_N(_0567_),
    .B(_0568_),
    .X(_0569_));
 sky130_fd_sc_hd__xnor2_2 _1244_ (.A(_0561_),
    .B(_0569_),
    .Y(_0570_));
 sky130_fd_sc_hd__o21a_2 _1245_ (.A1(_0546_),
    .A2(_0547_),
    .B1(_0544_),
    .X(_0571_));
 sky130_fd_sc_hd__xor2_2 _1246_ (.A(_0570_),
    .B(_0571_),
    .X(_0572_));
 sky130_fd_sc_hd__nand2_2 _1247_ (.A(_0560_),
    .B(_0572_),
    .Y(_0573_));
 sky130_fd_sc_hd__xor2_2 _1248_ (.A(_0560_),
    .B(_0572_),
    .X(_0574_));
 sky130_fd_sc_hd__nand2_2 _1249_ (.A(\core_out[14] ),
    .B(_0574_),
    .Y(_0575_));
 sky130_fd_sc_hd__inv_2 _1250_ (.A(_0575_),
    .Y(_0576_));
 sky130_fd_sc_hd__nor2_2 _1251_ (.A(\core_out[14] ),
    .B(_0574_),
    .Y(_0577_));
 sky130_fd_sc_hd__or2_2 _1252_ (.A(_0576_),
    .B(_0577_),
    .X(_0578_));
 sky130_fd_sc_hd__and2b_2 _1253_ (.A_N(_0528_),
    .B(_0555_),
    .X(_0579_));
 sky130_fd_sc_hd__o21ai_2 _1254_ (.A1(_0492_),
    ...
    .B1(_0579_),
    .Y(_0580_));
 sky130_fd_sc_hd__a21o_2 _1255_ (.A1(\core_out[13] ),
    .A2(_0554_),
    .B1(_0527_),
    .X(_0581_));
 sky130_fd_sc_hd__o21ai_2 _1256_ (.A1(\core_out[13] ),
    ...
    .B1(_0581_),
    .Y(_0582_));
 sky130_fd_sc_hd__a21oi_2 _1257_ (.A1(_0580_),
    .A2(_0582_),
    .B1(_0578_),
    .Y(_0583_));
 sky130_fd_sc_hd__and3_2 _1258_ (.A(_0578_),
    .B(_0580_),
    .C(_0582_),
    .X(_0584_));
 sky130_fd_sc_hd__o21ai_2 _1259_ (.A1(_0583_),
    .A2(_0584_),
    .B1(core_valid),
    .Y(_0585_));
 sky130_fd_sc_hd__o211a_2 _1260_ (.A1(core_valid),
    .A2(\core_out[14] ),
    .B1(_0083_),
    .C1(_0585_),
    .X(_0063_));
 sky130_fd_sc_hd__a21oi_2 _1261_ (.A1(_0561_),
    .A2(_0568_),
    .B1(_0567_),
    .Y(_0586_));
 sky130_fd_sc_hd__mux2_1 _1262_ (.A0(_0531_),
    ...
    .S(_0563_),
    .X(_0587_));
 sky130_fd_sc_hd__a211o_2 _1263_ (.A1(_0533_),
    .A2(_0537_),
    .B1(_0564_),
    .C1(_0587_),
    .X(_0588_));
 sky130_fd_sc_hd__a21bo_2 _1264_ (.A1(_0564_),
    .A2(_0587_),
    .B1_N(_0588_),
    .X(_0589_));
 sky130_fd_sc_hd__xor2_2 _1265_ (.A(_0586_),
    .B(_0589_),
    .X(_0590_));
 sky130_fd_sc_hd__o211a_2 _1266_ (.A1(_0570_),
    .A2(_0571_),
    .B1(_0573_),
    .C1(_0590_),
    .X(_0591_));
 sky130_fd_sc_hd__nor2_2 _1267_ (.A(\core_out[15] ),
    .B(_0591_),
    .Y(_0592_));
 sky130_fd_sc_hd__and2_2 _1268_ (.A(\core_out[15] ),
    .B(_0591_),
    .X(_0593_));
 sky130_fd_sc_hd__or2_2 _1269_ (.A(_0592_),
    .B(_0593_),
    .X(_0594_));
 sky130_fd_sc_hd__o21a_2 _1270_ (.A1(_0576_),
    .A2(_0583_),
    .B1(_0594_),
    .X(_0595_));
 sky130_fd_sc_hd__o31ai_2 _1271_ (.A1(_0576_),
    .A2(_0583_),
    .A3(_0594_),
    .B1(core_valid),
    .Y(_0596_));
 sky130_fd_sc_hd__o221a_2 _1272_ (.A1(core_valid),
    .A2(\core_out[15] ),
    .B1(_0595_),
    .B2(_0596_),
    .C1(_0083_),
    .X(_0064_));
 sky130_fd_sc_hd__xnor2_2 _1273_ (.A(\core_out[16] ),
    .B(_0591_),
    .Y(_0597_));
 sky130_fd_sc_hd__o21ba_2 _1274_ (.A1(_0575_),
    .A2(_0592_),
    .B1_N(_0593_),
    .X(_0598_));
 sky130_fd_sc_hd__or2_2 _1275_ (.A(_0577_),
    .B(_0592_),
    .X(_0599_));
 sky130_fd_sc_hd__a31o_2 _1276_ (.A1(_0580_),
    .A2(_0582_),
    .A3(_0598_),
    .B1(_0599_),
    .X(_0600_));
 sky130_fd_sc_hd__or2_2 _1277_ (.A(_0597_),
    .B(_0600_),
    .X(_0601_));
 sky130_fd_sc_hd__nand2_2 _1278_ (.A(_0597_),
    .B(_0600_),
    .Y(_0602_));
 sky130_fd_sc_hd__a21bo_2 _1279_ (.A1(_0601_),
    .A2(_0602_),
    .B1_N(core_valid),
    .X(_0603_));
 sky130_fd_sc_hd__o211a_2 _1280_ (.A1(core_valid),
    .A2(\core_out[16] ),
    .B1(_0083_),
    .C1(_0603_),
    .X(_0065_));
 sky130_fd_sc_hd__xnor2_2 _1281_ (.A(\core_out[17] ),
    .B(_0591_),
    .Y(_0604_));
 sky130_fd_sc_hd__a21bo_2 _1282_ (.A1(\core_out[16] ),
    .A2(_0591_),
    .B1_N(_0601_),
    .X(_0605_));
 sky130_fd_sc_hd__a21boi_2 _1283_ (.A1(_0604_),
    .A2(_0605_),
    .B1_N(core_valid),
    .Y(_0606_));
 sky130_fd_sc_hd__o21ai_2 _1284_ (.A1(_0604_),
    .A2(_0605_),
    .B1(_0606_),
    .Y(_0607_));
 sky130_fd_sc_hd__o211a_2 _1285_ (.A1(core_valid),
    .A2(\core_out[17] ),
    .B1(_0083_),
    .C1(_0607_),
    .X(_0066_));
 sky130_fd_sc_hd__nand2_2 _1286_ (.A(\core_out[18] ),
    .B(_0591_),
    .Y(_0608_));
 sky130_fd_sc_hd__xnor2_2 _1287_ (.A(\core_out[18] ),
    .B(_0591_),
    .Y(_0609_));
 sky130_fd_sc_hd__o21ai_2 _1288_ (.A1(\core_out[17] ),
    .A2(\core_out[16] ),
    .B1(_0591_),
    .Y(_0610_));
 sky130_fd_sc_hd__a2bb2o_2 _1289_ (.A1_N(\core_out[17] ),
    .A2_N(_0591_),
    .B1(_0601_),
    .B2(_0610_),
    .X(_0611_));
 sky130_fd_sc_hd__xnor2_2 _1290_ (.A(_0609_),
    .B(_0611_),
    .Y(_0612_));
 sky130_fd_sc_hd__nand2_2 _1291_ (.A(core_valid),
    .B(_0612_),
    .Y(_0613_));
 sky130_fd_sc_hd__o211a_2 _1292_ (.A1(core_valid),
    .A2(\core_out[18] ),
    .B1(_0083_),
    .C1(_0613_),
    .X(_0067_));
 sky130_fd_sc_hd__xnor2_2 _1293_ (.A(\core_out[19] ),
    .B(_0591_),
    .Y(_0614_));
 sky130_fd_sc_hd__o21a_2 _1294_ (.A1(_0609_),
    .A2(_0611_),
    .B1(_0608_),
    .X(_0615_));
 sky130_fd_sc_hd__xnor2_2 _1295_ (.A(_0614_),
    .B(_0615_),
    .Y(_0616_));
 sky130_fd_sc_hd__nand2_2 _1296_ (.A(core_valid),
    .B(_0616_),
    .Y(_0617_));
 sky130_fd_sc_hd__o211a_2 _1297_ (.A1(core_valid),
    .A2(\core_out[19] ),
    .B1(_0083_),
    .C1(_0617_),
    .X(_0068_));
 sky130_fd_sc_hd__xnor2_2 _1298_ (.A(\core_out[20] ),
    .B(_0591_),
    .Y(_0618_));
 sky130_fd_sc_hd__or4_2 _1299_ (.A(_0597_),
    .B(_0604_),
    .C(_0609_),
    .D(_0614_),
    .X(_0619_));
 sky130_fd_sc_hd__a311o_2 _1300_ (.A1(_0580_),
    .A2(_0582_),
    .A3(_0598_),
    .B1(_0599_),
    .C1(_0619_),
    .X(_0620_));
 sky130_fd_sc_hd__o41a_2 _1301_ (.A1(\core_out[19] ),
    .A2(\core_out[18] ),
    .A3(\core_out[17] ),
    .A4(\core_out[16] ),
    .B1(_0591_),
 ...
 sky130_fd_sc_hd__inv_2 _1302_ (.A(_0621_),
    .Y(_0622_));
 sky130_fd_sc_hd__and2_2 _1303_ (.A(_0620_),
    .B(_0622_),
    .X(_0623_));
 sky130_fd_sc_hd__or2_2 _1304_ (.A(_0618_),
    .B(_0623_),
    .X(_0624_));
 sky130_fd_sc_hd__nand2_2 _1305_ (.A(_0618_),
    .B(_0623_),
    .Y(_0625_));
 sky130_fd_sc_hd__a21bo_2 _1306_ (.A1(_0624_),
    .A2(_0625_),
    .B1_N(core_valid),
    .X(_0626_));
 sky130_fd_sc_hd__o211a_2 _1307_ (.A1(core_valid),
    .A2(\core_out[20] ),
    .B1(_0083_),
    .C1(_0626_),
    .X(_0069_));
 sky130_fd_sc_hd__xnor2_2 _1308_ (.A(\core_out[21] ),
    .B(_0591_),
    .Y(_0627_));
 sky130_fd_sc_hd__a21bo_2 _1309_ (.A1(\core_out[20] ),
    .A2(_0591_),
    .B1_N(_0624_),
    .X(_0628_));
 sky130_fd_sc_hd__a21boi_2 _1310_ (.A1(_0627_),
    .A2(_0628_),
    .B1_N(core_valid),
    .Y(_0629_));
 sky130_fd_sc_hd__o21ai_2 _1311_ (.A1(_0627_),
    .A2(_0628_),
    .B1(_0629_),
    .Y(_0630_));
 sky130_fd_sc_hd__o211a_2 _1312_ (.A1(core_valid),
    .A2(\core_out[21] ),
    .B1(_0083_),
    .C1(_0630_),
    .X(_0070_));
 sky130_fd_sc_hd__or2_2 _1313_ (.A(\core_out[22] ),
    .B(_0591_),
    .X(_0631_));
 sky130_fd_sc_hd__nand2_2 _1314_ (.A(\core_out[22] ),
    .B(_0591_),
    .Y(_0632_));
 sky130_fd_sc_hd__nand2_2 _1315_ (.A(_0631_),
    .B(_0632_),
    .Y(_0633_));
 sky130_fd_sc_hd__o21ai_2 _1316_ (.A1(\core_out[21] ),
    .A2(\core_out[20] ),
    .B1(_0591_),
    .Y(_0634_));
 sky130_fd_sc_hd__a2bb2o_2 _1317_ (.A1_N(\core_out[21] ),
    .A2_N(_0591_),
    .B1(_0624_),
    .B2(_0634_),
    .X(_0635_));
 sky130_fd_sc_hd__xnor2_2 _1318_ (.A(_0633_),
    .B(_0635_),
    .Y(_0636_));
 sky130_fd_sc_hd__nand2_2 _1319_ (.A(core_valid),
    .B(_0636_),
    .Y(_0637_));
 sky130_fd_sc_hd__o211a_2 _1320_ (.A1(core_valid),
    .A2(\core_out[22] ),
    .B1(_0083_),
    .C1(_0637_),
    .X(_0071_));
 sky130_fd_sc_hd__xnor2_2 _1321_ (.A(\core_out[23] ),
    .B(_0591_),
    .Y(_0638_));
 sky130_fd_sc_hd__o21a_2 _1322_ (.A1(_0633_),
    .A2(_0635_),
    .B1(_0632_),
    .X(_0639_));
 sky130_fd_sc_hd__xnor2_2 _1323_ (.A(_0638_),
    .B(_0639_),
    .Y(_0640_));
 sky130_fd_sc_hd__nor2_2 _1324_ (.A(core_valid),
    .B(\core_out[23] ),
    .Y(_0641_));
 sky130_fd_sc_hd__a211oi_2 _1325_ (.A1(core_valid),
    .A2(_0640_),
    .B1(_0641_),
    .C1(rst),
    .Y(_0072_));
 sky130_fd_sc_hd__xnor2_2 _1326_ (.A(\core_out[24] ),
    .B(_0591_),
    .Y(_0642_));
 sky130_fd_sc_hd__o41ai_2 _1327_ (.A1(\core_out[23] ),
    ...
    .B1(_0591_),
    .Y(_0643_));
 sky130_fd_sc_hd__or4_2 _1328_ (.A(_0618_),
    .B(_0627_),
    .C(_0633_),
    .D(_0638_),
    .X(_0644_));
 sky130_fd_sc_hd__a21o_2 _1329_ (.A1(_0620_),
    .A2(_0622_),
    .B1(_0644_),
    .X(_0645_));
 sky130_fd_sc_hd__a21o_2 _1330_ (.A1(_0643_),
    .A2(_0645_),
    .B1(_0642_),
    .X(_0646_));
 sky130_fd_sc_hd__nand3_2 _1331_ (.A(_0642_),
    .B(_0643_),
    .C(_0645_),
    .Y(_0647_));
 sky130_fd_sc_hd__a21bo_2 _1332_ (.A1(_0646_),
    .A2(_0647_),
    .B1_N(core_valid),
    .X(_0648_));
 sky130_fd_sc_hd__o211a_2 _1333_ (.A1(core_valid),
    .A2(\core_out[24] ),
    .B1(_0083_),
    .C1(_0648_),
    .X(_0073_));
 sky130_fd_sc_hd__xnor2_2 _1334_ (.A(\core_out[25] ),
    .B(_0591_),
    .Y(_0649_));
 sky130_fd_sc_hd__a21boi_2 _1335_ (.A1(\core_out[24] ),
    .A2(_0591_),
    .B1_N(_0646_),
    .Y(_0650_));
 sky130_fd_sc_hd__xnor2_2 _1336_ (.A(_0649_),
    .B(_0650_),
    .Y(_0651_));
 sky130_fd_sc_hd__nor2_2 _1337_ (.A(core_valid),
    .B(\core_out[25] ),
    .Y(_0652_));
 sky130_fd_sc_hd__a211oi_2 _1338_ (.A1(core_valid),
    .A2(_0651_),
    .B1(_0652_),
    .C1(rst),
    .Y(_0074_));
 sky130_fd_sc_hd__or2_2 _1339_ (.A(\core_out[26] ),
    .B(_0591_),
    .X(_0653_));
 sky130_fd_sc_hd__nand2_2 _1340_ (.A(\core_out[26] ),
    .B(_0591_),
    .Y(_0654_));
 sky130_fd_sc_hd__nand2_2 _1341_ (.A(_0653_),
    .B(_0654_),
    .Y(_0655_));
 sky130_fd_sc_hd__o21ai_2 _1342_ (.A1(\core_out[25] ),
    .A2(\core_out[24] ),
    .B1(_0591_),
    .Y(_0656_));
 sky130_fd_sc_hd__a2bb2o_2 _1343_ (.A1_N(\core_out[25] ),
    .A2_N(_0591_),
    .B1(_0646_),
    .B2(_0656_),
    .X(_0657_));
 sky130_fd_sc_hd__xnor2_2 _1344_ (.A(_0655_),
    .B(_0657_),
    .Y(_0658_));
 sky130_fd_sc_hd__nand2_2 _1345_ (.A(core_valid),
    .B(_0658_),
    .Y(_0659_));
 sky130_fd_sc_hd__o211a_2 _1346_ (.A1(core_valid),
    .A2(\core_out[26] ),
    .B1(_0083_),
    .C1(_0659_),
    .X(_0075_));
 sky130_fd_sc_hd__xnor2_2 _1347_ (.A(\core_out[27] ),
    .B(_0591_),
    .Y(_0660_));
 sky130_fd_sc_hd__o21ai_2 _1348_ (.A1(_0655_),
    .A2(_0657_),
    .B1(_0654_),
    .Y(_0661_));
 sky130_fd_sc_hd__xor2_2 _1349_ (.A(_0660_),
    .B(_0661_),
    .X(_0662_));
 sky130_fd_sc_hd__nor2_2 _1350_ (.A(core_valid),
    .B(\core_out[27] ),
    .Y(_0663_));
 sky130_fd_sc_hd__a211oi_2 _1351_ (.A1(core_valid),
    .A2(_0662_),
    .B1(_0663_),
    .C1(rst),
    .Y(_0076_));
 sky130_fd_sc_hd__or4_2 _1352_ (.A(_0642_),
    .B(_0649_),
    .C(_0655_),
    .D(_0660_),
    .X(_0664_));
 sky130_fd_sc_hd__a21oi_2 _1353_ (.A1(_0643_),
    .A2(_0645_),
    .B1(_0664_),
    .Y(_0665_));
 sky130_fd_sc_hd__o41a_2 _1354_ (.A1(\core_out[27] ),
    .A2(\core_out[26] ),
    .A3(\core_out[25] ),
    .A4(\core_out[24] ),
    .B1(_0591_),
    .X(_0666_));
 sky130_fd_sc_hd__nor2_2 _1355_ (.A(_0665_),
    .B(_0666_),
    .Y(_0667_));
 sky130_fd_sc_hd__and2_2 _1356_ (.A(\core_out[28] ),
    .B(_0591_),
    .X(_0668_));
 sky130_fd_sc_hd__nor2_2 _1357_ (.A(\core_out[28] ),
    .B(_0591_),
    .Y(_0669_));
 sky130_fd_sc_hd__or2_2 _1358_ (.A(_0668_),
    .B(_0669_),
    .X(_0670_));
 sky130_fd_sc_hd__inv_2 _1359_ (.A(_0670_),
    .Y(_0671_));
 sky130_fd_sc_hd__xnor2_2 _1360_ (.A(_0667_),
    .B(_0670_),
    .Y(_0672_));
 sky130_fd_sc_hd__nand2_2 _1361_ (.A(core_valid),
    .B(_0672_),
    .Y(_0673_));
 sky130_fd_sc_hd__o211a_2 _1362_ (.A1(core_valid),
    .A2(\core_out[28] ),
    .B1(_0083_),
    .C1(_0673_),
    .X(_0077_));
 sky130_fd_sc_hd__xor2_2 _1363_ (.A(\core_out[29] ),
    .B(_0591_),
    .X(_0674_));
 sky130_fd_sc_hd__o21ba_2 _1364_ (.A1(_0667_),
    .A2(_0670_),
    .B1_N(_0668_),
    .X(_0675_));
 sky130_fd_sc_hd__xor2_2 _1365_ (.A(_0674_),
    .B(_0675_),
    .X(_0676_));
 sky130_fd_sc_hd__nor2_2 _1366_ (.A(core_valid),
    .B(\core_out[29] ),
    .Y(_0677_));
 sky130_fd_sc_hd__a211oi_2 _1367_ (.A1(core_valid),
    .A2(_0676_),
    .B1(_0677_),
    .C1(rst),
    .Y(_0078_));
 sky130_fd_sc_hd__nor2_2 _1368_ (.A(\core_out[30] ),
    .B(_0591_),
    .Y(_0678_));
 sky130_fd_sc_hd__and2_2 _1369_ (.A(\core_out[30] ),
    .B(_0591_),
    .X(_0679_));
 sky130_fd_sc_hd__nor2_2 _1370_ (.A(_0678_),
    .B(_0679_),
    .Y(_0680_));
 sky130_fd_sc_hd__inv_2 _1371_ (.A(_0680_),
    .Y(_0681_));
 sky130_fd_sc_hd__o211ai_2 _1372_ (.A1(_0665_),
    .A2(_0666_),
    .B1(_0671_),
    .C1(_0674_),
    .Y(_0682_));
 sky130_fd_sc_hd__o21ai_2 _1373_ (.A1(\core_out[29] ),
    .A2(\core_out[28] ),
    .B1(_0591_),
    .Y(_0683_));
 sky130_fd_sc_hd__a21oi_2 _1374_ (.A1(_0682_),
    .A2(_0683_),
    .B1(_0681_),
    .Y(_0684_));
 sky130_fd_sc_hd__and3_2 _1375_ (.A(_0681_),
    .B(_0682_),
    .C(_0683_),
    .X(_0685_));
 sky130_fd_sc_hd__or2_2 _1376_ (.A(_0684_),
    .B(_0685_),
    .X(_0686_));
 sky130_fd_sc_hd__nor2_2 _1377_ (.A(core_valid),
    .B(\core_out[30] ),
    .Y(_0687_));
 sky130_fd_sc_hd__a211oi_2 _1378_ (.A1(core_valid),
    .A2(_0686_),
    .B1(_0687_),
    .C1(rst),
    .Y(_0079_));
 sky130_fd_sc_hd__xnor2_2 _1379_ (.A(\core_out[31] ),
    .B(_0591_),
    .Y(_0688_));
 sky130_fd_sc_hd__o21ai_2 _1380_ (.A1(_0679_),
    .A2(_0684_),
    .B1(_0688_),
    .Y(_0689_));
 sky130_fd_sc_hd__o31a_2 _1381_ (.A1(_0679_),
    .A2(_0684_),
    .A3(_0688_),
    .B1(core_valid),
    .X(_0690_));
 sky130_fd_sc_hd__nor2_2 _1382_ (.A(\core_out[31] ),
    .B(core_valid),
    .Y(_0691_));
 sky130_fd_sc_hd__a211oi_2 _1383_ (.A1(_0689_),
    .A2(_0690_),
    .B1(_0691_),
    .C1(rst),
    .Y(_0080_));
 ...
 sky130_fd_sc_hd__dfxtp_2 _1464_ (.CLK(clk),
    .D(_0080_),
    .Q(\core_out[31] ));
 sky130_fd_sc_hd__conb_1 _1465_ (.HI(ready));
